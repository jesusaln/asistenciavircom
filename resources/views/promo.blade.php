    ...
    <main class="w-full max-w-2xl mt-8 text-center">
        ...
        <div
            ...
            <div class="flex flex-col items-center">
                ...
                <a href="https://wa.me/5216624590092?text=Me%20interesa%20la%20camara%20HiLook%20de%202950"
                    class="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 px-8 rounded-xl transition-all shadow-lg hover:shadow-blue-500/50 flex items-center justify-center gap-2 group">
