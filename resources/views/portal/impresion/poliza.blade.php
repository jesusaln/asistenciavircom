...
<body>
    ...
    <div class="content">
        ...
        <p>
            ...
            (EN ADELANTE "EL PRESTADOR"), Y POR LA OTRA PARTE, <b>{{ $cliente->nombre_razon_social }}</b> (EN ADELANTE
            "EL CLIENTE"),
        ...
        <p>
            a) Ser una persona @if($cliente->tipo_persona == 'moral') moral @else física @endif con plena capacidad
            legal para obligarse en los términos del presente contrato.<br>
            b) Que su Registro Federal de Contribuyentes es <b>{{ $cliente->rfc }}</b>.<br>
        ...
        <p><span class="clause-title">SEGUNDA. VIGENCIA.</span> El presente contrato tendrá una vigencia del
            <b>{{ \Carbon\Carbon::parse($poliza->fecha_inicio)->format('d/m/Y') }}</b> al
            <b>{{ $poliza->fecha_fin ? \Carbon\Carbon::parse($poliza->fecha_fin)->format('d/m/Y') : 'INDEFINIDO' }}</b>.
        ...
        <div class="signatures">
            ...
            <div class="sig-block">
                ...
                <div class="sig-line">
                    {{ $poliza->firmado_nombre ?? $cliente->nombre_razon_social }}<br>
