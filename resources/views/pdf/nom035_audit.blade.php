...
<body>
    ...
    <div class="footer">
        Documento generado automáticamente por el Sistema de Gestión NOM-035 | {{ $empresa->nombre_empresa ?? 'Climas del Desierto' }} | {{ $fecha }}<br>
        <strong>Responsable de Implementación:</strong> {{ $config->responsible_name ?? 'Jesús Alberto López Noriega' }} ({{ $config->responsible_position ?? 'Representante' }})
    </div>
</body>
</html>
