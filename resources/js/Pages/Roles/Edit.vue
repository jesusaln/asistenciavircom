      ...
      <div class="w-full sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-slate-900 overflow-hidden shadow-xl sm:rounded-lg p-6">
          <div class="mb-8 border-b pb-4">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Rol</h2>
            <p class="text-sm text-gray-600 dark:text-gray-300">Modifica el nombre del rol y gestiona los niveles de acceso de forma detallada.</p>
          </div>
