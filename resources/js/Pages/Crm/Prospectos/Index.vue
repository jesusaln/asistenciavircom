    ...
    <div class="prospectos-index min-h-screen bg-white dark:bg-gray-900 transition-colors">
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                <Link href="/crm" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 font-medium rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 transition-all shadow-sm">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button
                                        ...
                                        class="w-8 h-8 flex items-center justify-center rounded-lg bg-red-50 dark:bg-red-900/40 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/60 transition-all"
        ...
        <ConfirmationModal :show="prospectoAEliminar != null" @close="cerrarModalEliminar" max-width="md">
            ...
            <template #content>
                ...
                <div class="mt-3 text-xs font-bold uppercase tracking-widest text-red-500 dark:text-red-400">
