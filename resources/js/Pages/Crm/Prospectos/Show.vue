<template>
    ...
    <div class="prospecto-show min-h-screen bg-white dark:bg-slate-900 dark:bg-gray-900 transition-colors">
        <div class="w-full px-4 lg:px-8 py-8 animate-fade-in">
        <!-- Header -->
        <div class="mb-6">
            <div class="flex items-center gap-4 mb-4">
                <Link href="/crm/prospectos" class="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 dark:text-gray-400 transition-colors">
                    <FontAwesomeIcon :icon="['fas', 'arrow-left']" />
                </Link>
                <div class="flex-1">
                    <div class="flex flex-wrap items-center gap-3">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-white transition-colors">{{ prospecto.nombre }}</h1>
                    ...
                    <p v-if="prospecto.empresa" class="text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1 transition-colors">{{ prospecto.empresa }}</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                <!-- Datos de contacto -->
                <div class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors">
                    <h3 class="font-bold text-gray-900 dark:text-white dark:text-white mb-4 flex items-center gap-2 transition-colors">
                    ...
                    <div class="space-y-4">
                        <div v-if="prospecto.telefono" class="flex items-center gap-3 group">
                            ...
                            <div class="flex-1">
                                <p class="text-[10px] text-gray-400 dark:text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider">Teléfono</p>
                        ...
                        <div v-if="prospecto.email" class="flex items-center gap-3">
                            ...
                            <div class="flex-1">
                                <p class="text-[10px] text-gray-400 dark:text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider">Email</p>
                        ...
                        <div v-if="prospecto.vendedor" class="flex items-center gap-3">
                            ...
                            <div class="flex-1">
                                <p class="text-[10px] text-gray-400 dark:text-gray-500 dark:text-gray-400 font-bold uppercase tracking-wider">Asignado a</p>
                ...
                <!-- Valor y fechas -->
                <div class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors">
                    <h3 class="font-bold text-gray-900 dark:text-white dark:text-white mb-4 transition-colors">Detalles del Negocio</h3>
                    <div class="space-y-4">
                        <div v-if="prospecto.valor_estimado" class="flex justify-between items-center bg-emerald-50/30 dark:bg-emerald-900/10 p-3 rounded-lg border border-emerald-100/50 dark:border-emerald-800/30 transition-colors">
                            <span class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 font-medium">Valor Estimado</span>
                            <span class="text-lg font-bold text-emerald-600 dark:text-emerald-400">${{ formatMonto(prospecto.valor_estimado) }}</span>
                        </div>
                        <div class="flex justify-between items-center p-2">
                            <span class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">Origen</span>
                        ...
                        <div v-if="prospecto.proxima_actividad_at" class="flex flex-col gap-1 p-2">
                            <span class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase font-bold tracking-wider">Próxima Actividad</span>
                            <div class="flex items-center gap-2">
                ...
                <!-- Cambiar etapa -->
                <div class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors">
                    <h3 class="font-bold text-gray-900 dark:text-white dark:text-white mb-4 transition-colors">Gestión de Pipeline</h3>
                    <div class="mb-4">
                        <label class="block text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Etapa Actual</label>
                        <select v-model="etapaSeleccionada" @change="cambiarEtapa" class="w-full px-4 py-2 bg-white dark:bg-slate-900 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 dark:text-white rounded-lg focus:ring-2 focus:ring-amber-500 outline-none transition-colors">
                ...
                <!-- Scripts disponibles -->
                <div v-if="scripts.length" class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors">
                    <h3 class="font-bold text-gray-900 dark:text-white dark:text-white mb-4 flex items-center gap-2 transition-colors">
                    ...
                    <div class="space-y-3">
                        <div 
                            ...
                            class="p-4 rounded-xl border border-gray-200 dark:border-slate-800 dark:border-gray-700 hover:border-amber-300 dark:hover:border-amber-500 hover:bg-amber-50/30 dark:hover:bg-amber-900/10 cursor-pointer transition-all active:scale-95 group"
                        >
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-bold text-gray-800 dark:text-gray-100 dark:text-gray-200 group-hover:text-amber-700 dark:group-hover:text-amber-400 transition-colors">{{ script.nombre }}</span>
                                </div>
                                <FontAwesomeIcon :icon="['fas', 'chevron-right']" class="w-3 h-3 text-gray-300 dark:text-gray-600 dark:text-gray-300 group-hover:text-amber-500 transition-colors" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Notas -->
                <div v-if="prospecto.notas" class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 transition-colors">
                    <h3 class="font-bold text-gray-900 dark:text-white dark:text-white mb-3 transition-colors">Notas Internas</h3>
                    <div class="bg-gray-50 dark:bg-slate-950 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 transition-colors">
                        <p class="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-400 whitespace-pre-line transition-colors">{{ prospecto.notas }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors">
                    <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-slate-950/30 dark:bg-gray-900/30 transition-colors">
                        <h3 class="font-bold text-gray-900 dark:text-white dark:text-white transition-colors">Historial de Actividades</h3>
                    </div>
                    <div class="p-6">
                        <div v-if="prospecto.actividades?.length" class="space-y-8 relative before:absolute before:inset-y-0 before:left-5 before:w-0.5 before:bg-gray-100 dark:before:bg-gray-700 transition-colors">
                            <div v-for="actividad in prospecto.actividades" :key="actividad.id" class="flex gap-4 relative">
                                ...
                                <div class="flex-1 bg-gray-50 dark:bg-slate-950/50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700 transition-colors">
                                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-1 mb-2">
                                        <span class="font-bold text-gray-900 dark:text-white dark:text-white transition-colors">{{ tiposActividad[actividad.tipo] }}</span>
                                        <span class="text-[10px] font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-widest">{{ formatFechaCompleta(actividad.created_at) }}</span>
                                    </div>
                                    ...
                                    <p v-if="actividad.notas" class="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 whitespace-pre-line mb-3 transition-colors">{{ actividad.notas }}</p>
                                    <div class="flex items-center gap-2">
                                        <div class="w-5 h-5 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-[8px] font-bold text-gray-500 dark:text-gray-400 dark:text-gray-400">
                                            {{ (actividad.usuario?.name || '?').substring(0,2).toUpperCase() }}
                                        </div>
                                        <p class="text-[10px] font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-wider">Registrado por {{ actividad.usuario?.name }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div v-else class="text-center py-16 text-gray-400 dark:text-gray-500 dark:text-gray-400">
                            <div class="mb-4 flex justify-center">
                                <div class="w-16 h-16 rounded-full bg-gray-50 dark:bg-slate-950 dark:bg-gray-900/50 flex items-center justify-center shadow-inner">
        ...
        <div v-if="showModalActividad" class="fixed inset-0 z-50 overflow-y-auto" @click.self="showModalActividad = false">
            <div class="flex items-center justify-center min-h-screen px-4 p-4 text-center">
                ...
                <div class="relative bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-scale-in text-left transition-colors">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white dark:text-white transition-colors">Registrar Actividad</h3>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1 uppercase font-bold tracking-widest">Nueva interacción</p>
                        </div>
                        <button @click="showModalActividad = false" class="text-gray-400 hover:text-gray-600 dark:text-gray-300">
                    ...
                    <form @submit.prevent="registrarActividad">
                        <div class="space-y-5">
                            <div class="grid grid-cols-2 gap-5">
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-2">Tipo *</label>
                                    <select v-model="formActividad.tipo" required class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-950 dark:bg-gray-900 border border-gray-200 dark:border-slate-800 dark:border-gray-700 dark:text-white rounded-xl focus:ring-2 focus:ring-amber-500 outline-none transition-colors">
                                        <option v-for="(label, key) in tiposActividad" :key="key" :value="key">{{ label }}</option>
                                    </select>
                                </div>
                                <div>
                                    <label class="block text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-2">Resultado</label>
                                    <select v-model="formActividad.resultado" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-slate-950 dark:bg-gray-900 border border-gray-200 dark:border-slate-800 dark:border-gray-700 dark:text-white rounded-xl focus:ring-2 focus:ring-amber-500 outline-none transition-colors">
                            ...
                            <div>
                                <label class="block text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-2">Notas Detalladas</label>
                                <textarea v-model="formActividad.notas" rows="4" class="w-full px-4 py-3 bg-gray-50 dark:bg-slate-950 dark:bg-gray-900 border border-gray-200 dark:border-slate-800 dark:border-gray-700 dark:text-white rounded-xl focus:ring-2 focus:ring-amber-500 outline-none transition-colors placeholder-gray-400 dark:placeholder-gray-600" placeholder="Describe los puntos clave de la interacción..."></textarea>
                            </div>
                            <div class="bg-blue-50/50 dark:bg-blue-900/10 p-4 rounded-xl border border-blue-100 dark:border-blue-800/50 transition-colors">
                                ...
                                <input v-model="formActividad.proxima_actividad_at" type="datetime-local" class="w-full px-4 py-2.5 bg-white dark:bg-slate-900 dark:bg-gray-800 border border-blue-200 dark:border-blue-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-colors" />
                            </div>
                        </div>

                        <div class="flex justify-end items-center gap-4 mt-8">
                            <button type="button" @click="showModalActividad = false" class="px-6 py-2.5 text-sm font-bold text-gray-500 dark:text-gray-400 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-colors uppercase tracking-widest">
                                Cancelar
                            </button>
        ...
        <div v-if="scriptActivo" class="fixed inset-0 z-50 overflow-y-auto" @click.self="scriptActivo = null">
            <div class="flex items-center justify-center min-h-screen px-4 p-4 text-center">
                <div class="fixed inset-0 bg-black/60 backdrop-blur-sm transition-all"></div>
                <div class="relative bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full p-8 animate-scale-in text-left transition-colors">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white dark:text-white transition-colors">{{ scriptActivo.nombre }}</h3>
                            <p class="text-[10px] text-amber-500 font-bold uppercase tracking-widest mt-1">Sugerencia de venta ({{ scriptActivo.tipo }})</p>
                        </div>
                        <button @click="scriptActivo = null" class="w-8 h-8 flex items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 dark:text-gray-400 hover:text-red-500 transition-all">
                            <FontAwesomeIcon :icon="['fas', 'times']" />
                        </button>
                    </div>
                    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 rounded-2xl p-8 mb-6 transition-colors shadow-inner">
                        <p class="text-gray-800 dark:text-gray-100 dark:text-gray-200 whitespace-pre-line text-lg leading-relaxed font-medium font-serif transition-colors italic">"{{ scriptActivo.contenido }}"</p>
                    </div>
...
const getEtapaColor = (etapa) => {
    const colors = { 
        prospecto: 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-400 border-gray-200 dark:border-slate-800 dark:border-gray-700', 
    ...
    return colors[etapa] || 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-400 border-gray-200 dark:border-slate-800 dark:border-gray-700';
};
...
const getPrioridadColor = (prioridad) => {
    ...
    return colors[prioridad] || 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-400 border-gray-200 dark:border-slate-800 dark:border-gray-700';
};
...
const getActividadIconColor = (tipo) => {
    const colors = { 
        ...
        nota: 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 dark:text-gray-400' 
    };
    return colors[tipo] || 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 dark:text-gray-400';
};
...
const getResultadoColor = (resultado) => {
    const colors = { 
        ...
        pendiente: 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-400 border-gray-200 dark:border-slate-800 dark:border-gray-700' 
    };
    return colors[resultado] || 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-400 border-gray-200 dark:border-slate-800 dark:border-gray-700';
};
