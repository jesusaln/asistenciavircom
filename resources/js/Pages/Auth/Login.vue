...
<template>
    ...
    <div :style="cssVars" class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
            <div class="bg-white py-10 px-6 sm:px-12 shadow-2xl shadow-gray-200/50 sm:rounded-[3rem] border border-gray-100 relative overflow-hidden group">
                 <!-- Decoración -->
                ...
                <form class="space-y-6 relative z-10" @submit.prevent="submit">
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ms-3 text-xs font-black uppercase tracking-widest text-gray-400 cursor-pointer hover:text-gray-600 transition-colors">Mantener sesión iniciada</label>
                    </div>
            ...
            <p class="mt-10 text-center text-[10px] font-black uppercase tracking-[0.3em] text-gray-400">
