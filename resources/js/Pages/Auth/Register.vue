...
<template>
    ...
    <div :style="cssVars" class="min-h-screen bg-white dark:bg-slate-900 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans transition-colors duration-300">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
            <div class="bg-white dark:bg-slate-900 dark:bg-gray-900 py-8 px-4 shadow-2xl shadow-gray-200/50 dark:shadow-none sm:rounded-[2rem] sm:px-10 border border-gray-100 dark:border-gray-800 relative overflow-hidden group transition-colors">
                <form class="space-y-6 relative z-10" @submit.prevent="submit">
                    ...
                    <div v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature">
                        <InputLabel for="terms">
                            <div class="flex items-center">
                                ...
                                <div class="ms-2 text-xs text-gray-600 dark:text-gray-300 dark:text-gray-400">
                                    Acepto los <a target="_blank" :href="route('terms.show')" class="underline text-gray-600 dark:text-gray-300 dark:text-gray-400 hover:text-[var(--color-primary)] font-bold">Términos de Servicio</a> y la <a target="_blank" :href="route('policy.show')" class="underline text-gray-600 dark:text-gray-300 dark:text-gray-400 hover:text-[var(--color-primary)] font-bold">Política de Privacidad</a>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-col gap-4 pt-4">
                        ...
                        <div class="text-center mt-2">
                            <Link :href="route('login')" class="text-xs font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 dark:text-gray-400 hover:text-[var(--color-primary)] transition-colors">
