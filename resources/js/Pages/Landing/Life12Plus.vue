...
const features = [
    { title: 'Alta Eficiencia', icon: 'bolt', color: 'from-brand-500 to-amber-600', text: 'Optimiza el consumo energético manteniendo el máximo confort en tu hogar.' },
...
<template>
    ...
    <div class="life12-page bg-[var(--ui-surface)] text-slate-900 dark:text-white font-sans selection:bg-sky-500 selection:text-white">
        ...
        <section data-section="hero" class="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-sky-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            ...
            <div class="absolute inset-0 select-none pointer-events-none overflow-hidden">
                ...
                <div class="absolute bottom-1/4 right-0 text-[15vw] font-black text-sky-200/10 dark:text-sky-400/[0.03] whitespace-nowrap leading-none transition-transform duration-150 ease-out will-change-transform" :style="{ transform: parallaxRow2 }">
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="order-2 lg:order-1 transition-all duration-700" :class="sectionVisibility.hero ? 'translate-x-0 opacity-100' : '-translate-x-12 opacity-0'">
                        ...
                        <h1 class="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tighter leading-[0.9] mb-6">
                            <span class="text-slate-900 dark:text-white">MIRAGE</span><br>
                        ...
                        <div class="flex flex-wrap items-center gap-6 mb-10">
                            <div class="text-center">
                                <span class="block text-2xl font-black text-sky-500">12,000</span>
                                <span class="text-[10px] font-bold uppercase tracking-wide text-slate-400">BTU</span>
                            </div>
                            <div class="w-px h-10 bg-slate-200 dark:bg-slate-700"></div>
                            <div class="text-center">
                                <span class="block text-2xl font-black text-sky-500">220V</span>
                                <span class="text-[10px] font-bold uppercase tracking-wide text-slate-400">Voltaje</span>
                            </div>
                            <div class="w-px h-10 bg-slate-200 dark:bg-slate-700"></div>
                            <div class="text-center">
                                <span class="block text-2xl font-black text-sky-500">R-410A</span>
                                <span class="text-[10px] font-bold uppercase tracking-wide text-slate-400">Ecológico</span>
                            </div>
                        </div>

                        <div class="flex flex-col sm:flex-row gap-4">
                            <a :href="whatsappUrl" target="_blank" class="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-sky-500 to-cyan-500 text-white font-black rounded-2xl hover:shadow-2xl hover:shadow-sky-500/30 hover:scale-105 transition-all duration-200 uppercase text-xs tracking-wide">
                                <font-awesome-icon :icon="['fab', 'whatsapp']" class="text-lg" />
                                Cotizar por WhatsApp
                            </a>
                            <a href="#video" class="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-slate-100 dark:bg-white/5 text-slate-700 dark:text-slate-200 font-black rounded-2xl hover:bg-slate-200 dark:hover:bg-white/10 transition-all duration-200 uppercase text-xs tracking-wide border border-slate-200 dark:border-white/10">
                    ...
                    <!-- Right: Product Image -->
                    <div class="order-1 lg:order-2 relative transition-all duration-700 delay-300" :class="sectionVisibility.hero ? 'scale-100 opacity-100' : 'scale-90 opacity-0'" :style="{ opacity: heroOpacity, transform: `scale(${heroScale})` }">
                        ...
                        <div class="relative p-8 sm:p-12 group" :style="{ transform: heroImageFloat }">
                            <img src="/images/products/life12plus/product-nobg.png" class="relative z-10 w-full h-auto drop-shadow-[0_20px_40px_rgba(14,165,233,0.25)] transform group-hover:scale-105 group-hover:shadow-xl hover:shadow-xl transition-all duration-700" alt="Mirage Life 12+ Real">
                            ...
                            <div class="absolute bottom-0 right-4 z-20 bg-gradient-to-br from-sky-600 to-blue-700 text-white px-6 py-4 rounded-2xl shadow-xl shadow-sky-500/30 animate-pulse-soft">
                                <span class="text-[10px] font-bold uppercase tracking-wide opacity-90 block text-amber-300"><font-awesome-icon icon="fire" class="mr-1" />Súper Promo</span>
                                <span class="text-sm line-through opacity-60 block">$7,499</span>
                                <span class="text-2xl sm:text-2xl font-black text-white">$4,900</span>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                    <div v-for="(f, i) in features" :key="i" 
                        class="group p-8 bg-white/40 dark:bg-slate-800/50 backdrop-blur-xl rounded-[2.5rem] border border-white/50 dark:border-white/5 shadow-xl hover:shadow-sky-500/10 transition-all duration-500 hover:shadow-xl hover:shadow-xl"
                        :class="sectionVisibility.features ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'"
                        :style="{ transitionDelay: `${i * 100}ms` }">
                        <div class="w-16 h-16 rounded-2xl bg-gradient-to-br flex items-center justify-center text-white mb-6 transform group-hover:rotate-12 transition-transform shadow-xl" :class="f.color">
        ...
        <section data-section="details" class="py-20 lg:py-32 px-4 bg-white dark:bg-slate-950">
            <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                <div class="relative flex items-center justify-center transition-all duration-700" :class="sectionVisibility.details ? 'opacity-100' : 'opacity-0'">
                ...
                <div>
                    ...
                    <p class="mt-8 text-[10px] text-slate-400">*El control vía WiFi requiere módulo adicional no incluido en el equipo base.</p>
                </div>
            </div>
        </section>
        ...
        <!-- ═══════════════════════════════════════════ -->
        <section data-section="gallery" class="py-20 lg:py-32 px-4 bg-[var(--ui-surface)] overflow-hidden">
            <div class="max-w-7xl mx-auto">
                <div class="grid lg:grid-cols-2 gap-8 mb-8">
                    <!-- Living Room Experience -->
                    <div class="relative rounded-[3rem] overflow-hidden group h-[500px] lg:h-[600px] shadow-2xl transition-all duration-700" :class="sectionVisibility.gallery ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'">
                        <img src="/images/products/life12plus/real-room.png" class="absolute inset-0 w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-[10s] ease-linear" alt="Minisplit en sala real">
                    ...
                    <!-- Bedroom Experience -->
                    <div class="relative rounded-[3rem] overflow-hidden group h-[500px] lg:h-[600px] shadow-2xl transition-all duration-700 delay-300" :class="sectionVisibility.gallery ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'">
                        <img src="/images/products/life12plus/bedroom.png" class="absolute inset-0 w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-[10s] ease-linear" alt="Minisplit en recámara">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent"></div>
                        <div class="absolute bottom-12 left-12 right-12 text-white">
                ...
                <div class="text-center mt-12">
                    <p class="text-slate-500 dark:text-slate-400 italic">"Sentirás el confort, no el ruido."</p>
                </div>

                <!-- Warranty & Confidence Badges -->
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 mt-20 border-t border-slate-100 dark:border-white/5 pt-12">
                    <div class="text-center">
                        <div class="w-10 h-10 bg-sky-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                            <font-awesome-icon icon="shield-alt" class="text-sky-500 text-xl" />
                        </div>
                        <h4 class="text-sm font-black uppercase tracking-wide mb-1">6 Años</h4>
                        <p class="text-[10px] text-slate-400 uppercase tracking-wide">Garantía en Compresor</p>
                    </div>
                    <div class="text-center">
                        <div class="w-10 h-10 bg-sky-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                            <font-awesome-icon icon="certificate" class="text-sky-500 text-xl" />
                        </div>
                        <h4 class="text-sm font-black uppercase tracking-wide mb-1">Certificado</h4>
                        <p class="text-[10px] text-slate-400 uppercase tracking-wide">Técnicos Autorizados</p>
                    </div>
                    <div class="text-center">
                        <div class="w-10 h-10 bg-sky-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                            <font-awesome-icon icon="truck" class="text-sky-500 text-xl" />
                        </div>
                        <h4 class="text-sm font-black uppercase tracking-wide mb-1 text-slate-800 dark:text-white">Inmediato</h4>
                        <p class="text-[10px] text-sky-600/60 dark:text-sky-400/60 uppercase tracking-wide font-bold">Entrega en Hermosillo</p>
                    </div>
                    <div class="text-center">
                        <div class="w-10 h-10 bg-sky-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                            <font-awesome-icon icon="credit-card" class="text-sky-500 text-xl" />
                        </div>
                        <h4 class="text-sm font-black uppercase tracking-wide mb-1">MSI</h4>
                        <p class="text-[10px] text-slate-400 uppercase tracking-wide">Tarjetas Participantes</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section data-section="comparison" class="py-20 lg:py-32 px-4 bg-white dark:bg-slate-950">
            <div class="max-w-4xl mx-auto transition-all duration-700" :class="sectionVisibility.comparison ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'">
                <div class="text-center mb-16">
                ...
                <div class="grid md:grid-cols-2 gap-0 rounded-[3rem] overflow-hidden border border-slate-100 dark:border-white/5 shadow-2xl">
                    <div class="p-8 lg:p-12 bg-[var(--ui-surface)] dark:bg-black/50">
                        <h4 class="text-slate-400 font-black uppercase tracking-wide text-sm mb-8">Minisplit Estándar</h4>
                        <ul class="space-y-6">
                            <li class="flex items-center gap-2 text-slate-400 text-sm italic line-through decoration-slate-300">
                    ...
                    <div class="p-8 lg:p-12 bg-gradient-to-br from-brand-500 to-brand-600 text-white relative overflow-hidden">
                        <div class="absolute -top-10 -right-10 w-32 h-32 bg-white/10 rounded-full blur-2xl"></div>
                        <h4 class="text-sky-200 font-black uppercase tracking-wide text-sm mb-8">Mirage Life 12+</h4>
                        <ul class="space-y-6">
        ...
        <!-- ═══════════════════════════════════════════ -->
        <section data-section="testimonials" class="py-20 bg-sky-50/30 dark:bg-slate-800/30">
            <div class="max-w-7xl mx-auto px-4">
                <div class="text-center mb-16 transition-all duration-700" :class="sectionVisibility.testimonials ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div v-for="(t, i) in [
                    ...
                    ]" :key="i" class="bg-white dark:bg-slate-800 p-8 rounded-[2.5rem] border border-slate-100 dark:border-white/5 shadow-xl transition-all hover:shadow-xl hover:shadow-xl">
                        <div class="flex text-brand-400 mb-4 gap-1">
                            <font-awesome-icon v-for="s in t.stars" :key="s" icon="star" />
                        </div>
                        <p class="text-slate-500 dark:text-slate-400 text-sm italic mb-6 leading-relaxed">"{{ t.text }}"</p>
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] text-slate-400 uppercase font-bold">{{ t.loc }}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section data-section="steps" class="py-20 bg-[var(--ui-surface)] dark:bg-black/50">
            <div class="max-w-5xl mx-auto px-4">
                <div class="text-center mb-12 transition-all duration-700" :class="sectionVisibility.steps ? 'opacity-100' : 'opacity-0'">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    ]" :key="i" class="relative text-center group transition-all duration-700" 
                       :class="sectionVisibility.steps ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'"
                       :style="{ transitionDelay: `${i * 200}ms` }">
                        <div :class="`w-16 h-16 ${step.n === '3' ? 'bg-sky-500 shadow-sky-500/20 text-white' : 'bg-white dark:bg-slate-950 text-sky-500'} rounded-2xl shadow-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-105 transition-transform`">
                            <font-awesome-icon v-if="step.icon" :icon="step.icon" class="text-xl" />
                            <span v-else class="text-2xl font-black">{{ step.n }}</span>
                        </div>
                        <h4 class="font-black mb-2 uppercase tracking-wide text-sm">{{ step.t }}</h4>
                        <p class="text-xs text-slate-500 dark:text-slate-400">{{ step.d }}</p>
                        <div v-if="i < 2" class="hidden md:block absolute top-8 -right-4 w-8 h-px bg-slate-200 dark:bg-white/10"></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="relative rounded-[2rem] overflow-hidden shadow-2xl shadow-sky-500/10 border border-white/10 aspect-video">
                    ...
                    <div v-if="!showVideo" class="absolute inset-0 cursor-pointer group" @click="showVideo = true">
                        ...
                        <div class="absolute inset-0 bg-black/50 group-hover:bg-black/50 transition-colors flex items-center justify-center">
                            <div class="w-16 h-16 bg-sky-500 rounded-full flex items-center justify-center group-hover:scale-105 transition-transform shadow-2xl shadow-sky-500/40">
        ...
        <!-- SPECS TABLE -->
        <!-- ═══════════════════════════════════════════ -->
        <section class="py-20 lg:py-32 px-4 bg-[var(--ui-surface)] dark:bg-black/50">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-white/5 overflow-hidden shadow-xl">
                    <div v-for="(spec, i) in specs" :key="i" class="flex items-center justify-between p-6 border-b border-slate-50 dark:border-white/5 last:border-0 hover:bg-sky-50/50 dark:hover:bg-sky-500/5 transition-colors group">
                        <div class="flex items-center gap-4">
                            ...
                            <span class="font-bold text-sm text-slate-500 dark:text-slate-400 uppercase tracking-wide">{{ spec.label }}</span>
                        </div>
                ...
                <div class="mt-8 flex flex-wrap justify-center gap-4">
                    <a href="https://images.mirage.mx/pdf/specs/minisplit_life12.pdf" target="_blank" class="inline-flex items-center gap-2 px-6 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 rounded-xl text-sm font-bold text-slate-500 dark:text-slate-200 hover:border-brand-300 hover:text-sky-500 transition-all">
                        <font-awesome-icon icon="file-pdf" class="text-rose-500" />
                        Ficha Técnica PDF
                    </a>
        ...
        <section data-section="promo" class="py-20 lg:py-32 px-4 bg-gradient-to-br from-slate-900 via-sky-950 to-blue-950 relative overflow-hidden border-y border-sky-500/20">
            <div class="absolute inset-0">
                ...
                <div class="absolute -bottom-32 -right-32 w-96 h-96 bg-brand-500/10 rounded-full blur-3xl"></div>
            </div>
            <div class="relative z-10 max-w-5xl mx-auto transition-all duration-700" :class="sectionVisibility.promo ? 'opacity-100 scale-100' : 'opacity-0 scale-95'">
                <div class="text-center mb-12">
                    <div class="inline-flex items-center gap-2 px-5 py-2 bg-sky-500/20 border border-sky-500/30 backdrop-blur-sm rounded-full mb-6 animate-pulse-soft">
                        <font-awesome-icon icon="fire" class="text-amber-400" />
                    ...
                    <!-- Countdown / Scarcity -->
                    <div class="inline-block px-6 py-3 bg-brand-500/10 backdrop-blur-md rounded-2xl border border-rose-500/20 mb-4 shadow-xl shadow-rose-500/5">
                        <p class="text-rose-200 text-sm font-bold">
                            <font-awesome-icon icon="clock" class="mr-2 animate-pulse" />
                            ¡Solo quedan <span class="text-brand-400 font-black">4 unidades</span> a este precio!
                        </p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
                    <!-- Solo Equipo -->
                    <div class="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 text-center text-white hover:bg-white/10 transition-all hover:scale-105 duration-200">
                        ...
                        <h3 class="text-xl font-black uppercase tracking-wide mb-2 text-sky-100">Solo Equipo</h3>
                        ...
                        <div class="bg-white/5 rounded-2xl p-4 mb-6 text-left space-y-2">
                            ...
                            <div class="flex items-center gap-2 text-[9px] uppercase font-bold text-brand-400/80 italic mt-2">
                        ...
                        <a :href="whatsappUrl" target="_blank" class="inline-flex items-center gap-2 px-8 py-4 bg-sky-500/20 border border-sky-500/50 text-white font-black rounded-2xl hover:bg-sky-500 hover:shadow-2xl hover:shadow-sky-500/30 transition-all uppercase text-xs tracking-wide">
                            <font-awesome-icon :icon="['fab', 'whatsapp']" class="text-lg" />
                            Lo Quiero
                        </a>
                    </div>
                    ...
                    <!-- Con Instalación -->
                    <div class="bg-gradient-to-b from-brand-500 to-brand-600 rounded-3xl p-8 border-4 border-sky-400 text-center text-white shadow-2xl shadow-sky-500/20 hover:scale-105 transition-all duration-200 relative">
                        <div class="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-brand-400 text-slate-900 text-[10px] font-black uppercase tracking-wide rounded-full shadow-xl border border-brand-200 dark:border-brand-800/30">
                        ...
                        <h3 class="text-xl font-black uppercase tracking-wide mb-2">Equipo + Instalación</h3>
                        ...
                        <span class="text-5xl font-black text-brand-300 block my-2 drop-shadow-sm">$5,900</span>
                        <span class="text-xs text-sky-100/70 block mb-6 uppercase tracking-wider">IVA incluido · Todo incluido</span>
                        <a :href="whatsappUrl" target="_blank" class="inline-flex items-center gap-2 px-8 py-4 bg-white text-sky-800 dark:text-sky-200 font-black rounded-2xl hover:bg-sky-50 hover:shadow-2xl hover:shadow-white/40 transition-all uppercase text-xs tracking-wide">
                            <font-awesome-icon :icon="['fab', 'whatsapp']" class="text-lg" />
                            Agendar Instalación
                        </a>
                    </div>
                ...
                <div class="mt-16 flex flex-wrap justify-center items-center gap-10 lg:gap-14 opacity-50 hover:opacity-100 transition-opacity">
                    ...
                    <div class="flex items-center gap-2 text-white font-black text-[10px] uppercase tracking-[0.2em]">
                        <font-awesome-icon icon="award" class="text-amber-400" />
        ...
        <section data-section="guide" class="py-20 lg:py-32 px-4 bg-slate-950 text-white overflow-hidden relative">
            ...
            <div class="max-w-5xl mx-auto relative z-10 transition-all duration-700" :class="sectionVisibility.guide ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'">
                <div class="text-center mb-16">
                ...
                <div class="grid sm:grid-cols-3 gap-8">
                    ...
                    ]" :key="i" class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 text-center hover:bg-white/10 transition-all hover:shadow-xl hover:shadow-xl">
                ...
                <p class="text-center text-slate-500 text-xs mt-12 italic">*Las áreas son aproximadas y pueden variar según la carga térmica de la habitación (ventanas, sol, etc.)</p>
            </div>
        </section>
        ...
        <section data-section="models" class="py-20 lg:py-32 px-4 bg-white dark:bg-slate-950">
            <div class="max-w-5xl mx-auto transition-all duration-700" :class="sectionVisibility.models ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'">
                <div class="text-center mb-16">
                    ...
                    <p class="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">Disponible en versiones de solo frío y frío/calor, en 110V y 220V</p>
                </div>
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div v-for="m in [
                    ...
                    ]" :key="m.modelo" class="relative bg-sky-50/20 dark:bg-slate-800 rounded-3xl p-5 border border-sky-100 dark:border-white/5 hover:border-brand-300 transition-all group">
                        <div class="flex items-center justify-between mb-3">
                            <span class="text-lg font-black text-sky-600 dark:text-sky-400">{{ m.ton }}</span>
                            <span class="text-[8px] font-black text-sky-700/60 bg-sky-100/50 px-2 py-1 rounded-full uppercase tracking-wide">{{ m.volt }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between mt-3">
                            ...
                            <a :href="whatsappUrl" target="_blank" class="w-10 h-10 bg-sky-500 rounded-xl flex items-center justify-center text-white text-xs hover:scale-105 transition-all">
        ...
        <!-- FAQ SECTION -->
        <!-- ═══════════════════════════════════════════ -->
        <section data-section="faq" class="py-20 lg:py-32 px-4 bg-[var(--ui-surface)] dark:bg-slate-800/30">
            <div class="max-w-3xl mx-auto transition-all duration-700" :class="sectionVisibility.faq ? 'opacity-100 scale-100' : 'opacity-0 scale-95'">
                <div class="text-center mb-16">
                ...
                <div class="space-y-6">
                    <div v-for="(faq, index) in [
                    ...
                    ]" :key="index" class="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-white/5 overflow-hidden shadow-sm">
                        <button @click="toggleFaq(index)" class="w-full p-6 text-left flex justify-between items-center hover:bg-sky-50/50 dark:hover:bg-white/5 transition-colors">
                            ...
                            <font-awesome-icon :icon="activeFaq === index ? 'chevron-up' : 'chevron-down'" class="text-slate-400 text-xs" />
                        </button>
                        <div v-show="activeFaq === index" class="px-6 pb-6 pt-2 text-sm text-slate-500 dark:text-slate-400 border-t border-slate-50 dark:border-white/5 animate-fade-in">
        ...
        <section class="py-20 lg:py-32 px-4 bg-gradient-to-br from-sky-600 via-sky-500 to-cyan-500 relative overflow-hidden">
            ...
            <div class="relative z-10 max-w-4xl mx-auto text-center text-white">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a :href="whatsappUrl" target="_blank" class="group inline-flex items-center justify-center gap-3 px-10 py-5 bg-white text-sky-600 font-black rounded-2xl hover:scale-105 transition-all shadow-2xl uppercase text-xs tracking-wide">
                        <font-awesome-icon :icon="['fab', 'whatsapp']" class="text-xl" />
                        Hablar con un Experto
                    </a>
                    <a href="tel:6624317082" class="inline-flex items-center justify-center gap-3 px-10 py-5 bg-sky-700/50 text-white font-black rounded-2xl hover:bg-sky-700 transition-all backdrop-blur-sm border border-white/20 uppercase text-xs tracking-wide">
        ...
        <div class="fixed bottom-6 right-6 z-50 lg:hidden transition-all duration-500" :class="scrollY > 500 ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'">
            <a :href="whatsappUrl" target="_blank" class="flex items-center gap-2 bg-brand-500 text-white p-4 rounded-full shadow-2xl hover:scale-105 transition-transform">
                <font-awesome-icon :icon="['fab', 'whatsapp']" class="text-2xl" />
                <span class="font-black text-xs uppercase tracking-wide pr-2">¡Lo quiero!</span>
            </a>
        </div>
