    ...
    <div :style="cssVars" class="min-h-screen  flex flex-col font-sans">
        ...
        <main class="flex-grow">
                ...
                <div class="relative z-10 max-w-7xl mx-auto px-4 py-20 w-full">
                    <div class="max-w-2xl">
                        ...
                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/10 mb-8">
                            ...
                            <span class="text-emerald-400 text-xs font-bold uppercase tracking-wide">Servicio Disponible Hoy</span>
                        </div>
                        ...
                        <div class="flex gap-8 mt-12 pt-8 border-t border-white/10">
                            <div>
                                <p class="text-2xl font-black text-[var(--color-primary)]">500+</p>
                                <p class="text-xs text-slate-400 font-bold uppercase tracking-wide">Reparaciones / Año</p>
                            </div>
                            <div>
                                <p class="text-2xl font-black text-white">98%</p>
                                <p class="text-xs text-slate-400 font-bold uppercase tracking-wide">Clientes Satisfechos</p>
                            </div>
                            <div>
                                <p class="text-2xl font-black text-white">90 días</p>
                                <p class="text-xs text-slate-400 font-bold uppercase tracking-wide">Garantía Mínima</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="py-24  transition-colors">
                <div class="max-w-7xl mx-auto px-4">
                    <div class="text-center mb-16">
                        ...
                        <p class="mt-4 text-slate-500 dark:text-slate-400 max-w-2xl mx-auto transition-colors">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div 
                            ...
                            :key="i"
                            class="group p-8 rounded-3xl bg-[var(--ui-surface)] dark:bg-black/50 border border-slate-100 dark:border-slate-700 hover:shadow-xl hover:border-[var(--color-primary)]/30 hover:shadow-xl hover:shadow-xl transition-all duration-500"
                        >
                            <span class="text-5xl mb-6 block group-hover:scale-105 transition-transform">{{ problema.icono }}</span>
                            <h3 class="text-xl font-black text-slate-100 text-slate-100 mb-3 transition-colors">{{ problema.titulo }}</h3>
                            <p class="text-slate-500 dark:text-slate-400 text-sm leading-relaxed transition-colors">{{ problema.desc }}</p>
                        </div>
                    </div>
                    ...
                    <div class="text-center mt-12">
                        <a 
                            :href="whatsappLink" 
                            target="_blank"
                            class="inline-flex items-center gap-2 px-8 py-4 bg-[var(--color-primary)] text-white rounded-2xl font-bold text-sm uppercase tracking-wide shadow-xl hover:shadow-xl hover:scale-105 transition-all"
                        >
            ...
            <section class="py-24 bg-slate-900/20 transition-colors">
                <div class="max-w-7xl mx-auto px-4">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        >
                            <div class="w-16 h-16 bg-black/50 dark:bg-slate-800 rounded-3xl flex items-center justify-center text-4xl mb-8 group-hover:scale-105 group-hover:bg-[var(--color-primary-soft)] transition-all shadow-sm">
                                {{ step.icono }}
                            </div>
                            <span class="absolute -top-4 -right-2 text-7xl font-black text-slate-50 dark:text-slate-200/50 opacity-0 group-hover:opacity-100 transition-opacity select-none">{{ step.paso }}</span>
                            <h3 class="text-2xl font-black text-slate-100 text-slate-100 mb-4 transition-colors">{{ step.titulo }}</h3>
            ...
            <section class="py-24 bg-slate-950 text-white relative overflow-hidden">
                ...
                <div class="absolute bottom-0 left-0 w-64 h-64 bg-brand-500 rounded-full blur-[150px] opacity-10"></div>
                ...
                <div class="max-w-7xl mx-auto px-4 relative z-10">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div v-for="(v, i) in [
                            ...
                            <span class="text-4xl mb-6 block group-hover:scale-105 transition-transform">{{ v.icono }}</span>
                ...
                <div class="max-w-4xl mx-auto px-4">
                    ...
                    <div class="space-y-6">
                        ...
                        >
                            ...
                            >
                                <span class="font-black text-slate-100 text-slate-100 group-hover:text-[var(--color-primary)] transition-colors text-lg leading-snug pr-4">{{ faq.pregunta }}</span>
                                <span class="w-10 h-10 rounded-xl bg-black/50 dark:bg-slate-800 flex items-center justify-center text-slate-400 transition-all duration-500 shrink-0" :class="{'rotate-180 !bg-[var(--color-primary)] !text-white shadow-xl': activeFaq === faq.id}">
            ...
            <section class="py-24 bg-slate-900/20 transition-colors">
                <div class="max-w-7xl mx-auto px-4">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        >
                            <span class="text-5xl mb-6 block group-hover:scale-105 transition-transform">{{ servicio.icono }}</span>
            ...
            <!-- CTA FINAL -->
            <section class="py-20 bg-gradient-to-br from-[var(--color-primary)] to-brand-600 text-white relative overflow-hidden">
                <div class="absolute inset-0 opacity-10">
                    <div class="absolute top-0 left-1/4 w-96 h-96 bg-black/50 rounded-full blur-[150px]"></div>
                    <div class="absolute bottom-0 right-1/4 w-64 h-64 bg-black/50 rounded-full blur-[100px]"></div>
                </div>
                ...
                <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a 
                            :href="whatsappLink" 
                            target="_blank"
                            class="px-10 py-5 bg-black/50 text-slate-100 rounded-2xl font-black text-sm uppercase tracking-wide hover:shadow-2xl hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3"
                        >
                        ...
                        <a 
                            ...
                            class="px-10 py-5 border-2 border-white/30 rounded-2xl font-black text-sm uppercase tracking-wide hover:bg-white/10 transition-all duration-200 flex items-center justify-center gap-3"
                        >
                            📞 Llamar Ahora
                        </a>
                    </div>
