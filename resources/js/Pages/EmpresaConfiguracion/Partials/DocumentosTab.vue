    ...
    <div class="space-y-8">
        <div>
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-6 flex items-center gap-2">
                <FontAwesomeIcon icon="file-contract" class="text-gray-600 dark:text-gray-400" />
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Se mostrarán en cotizaciones y contratos.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div class="md:col-span-2">
                         <h3 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-3">Pies de Página en PDF</h3>
                    </div>
                ...
                <!-- Logo para Reportes -->
                 <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                    <h3 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-4">Logo para Documentos PDF</h3>
                    <div class="flex items-center gap-6">
                        <div class="w-32 h-16 border dark:border-gray-600 rounded-lg flex items-center justify-center bg-white dark:bg-gray-700 overflow-hidden">
                             ...
                             <FontAwesomeIcon v-else icon="file-pdf" class="text-gray-300 dark:text-gray-500 text-2xl" />
                        </div>
                        <div class="flex-1 max-w-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Subir Logo Alternativo</label>
                            <input type="file" @change="handleLogoReportesChange" accept="image/*" class="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 mb-2" />
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Si se deja vacío, se usará el logo principal. Útil si necesitas un logo diferente (ej. blanco y negro) para impresiones.</p>
