        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <p v-if="form.errors.nombre_empresa" class="mt-1 text-sm text-red-600 font-medium">
                ...
                <div>
                    ...
                    <input v-model="form.rfc" id="rfc" type="text" maxlength="13"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent uppercase transition-all"
                        placeholder="XAXX010101000" />
                    <p v-if="form.errors.rfc" class="mt-1 text-sm text-red-600 font-medium">
                        {{ form.errors.rfc }}
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p v-if="form.errors.razon_social" class="mt-1 text-sm text-red-600 font-medium">
                ...
                <div class="md:col-span-2">
                    <label for="regimen_fiscal" class="block text-sm font-medium text-gray-700 mb-2">
                        Régimen Fiscal (SAT) *
                        <span class="text-xs text-blue-600 font-normal ml-2">Requerido para CFDI 4.0</span>
                    </label>
                    ...
                    <p v-if="form.errors.regimen_fiscal" class="mt-1 text-sm text-red-600 font-medium">
                ...
                <div class="md:col-span-2">
                    <h3 class="text-md font-medium text-gray-900 mb-4 flex items-center gap-2 border-b pb-2">
                        <FontAwesomeIcon icon="map-marker-alt" class="text-gray-400" /> Dirección
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p v-if="form.errors.calle" class="mt-1 text-sm text-red-600 font-medium">
                                {{ form.errors.calle }}
                            </p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="button" @click="validarCodigoPostalEmpresa"
                                    class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 border border-gray-300 transition-colors"
                                    title="Buscar CP">
                ...
                <div class="md:col-span-2 mt-4">
                    <h3 class="text-md font-medium text-gray-900 mb-4 flex items-center gap-2 border-b pb-2">
                        <FontAwesomeIcon icon="address-book" class="text-gray-400" /> Contacto
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
