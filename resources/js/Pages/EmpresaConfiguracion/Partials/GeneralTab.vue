        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="nombre_empresa" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                        Nombre de la Empresa *
                    </label>
                    ...
                    <p v-if="form.errors.nombre_empresa" class="mt-1 text-sm text-rose-600 dark:text-rose-400 font-medium">
                ...
                <!-- RFC -->
                <div>
                    <label for="rfc" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                        RFC
                    </label>
                    <input v-model="form.rfc" id="rfc" type="text" maxlength="13"
                        class="w-full px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-transparent uppercase transition-all bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-200"
                        placeholder="XAXX010101000" />
                    <p v-if="form.errors.rfc" class="mt-1 text-sm text-rose-600 dark:text-rose-400 font-medium">
                        {{ form.errors.rfc }}
                    </p>
                </div>
                ...
                <!-- Razón Social -->
                <div>
                    <label for="razon_social" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                        Razón Social
                    </label>
                    <input v-model="form.razon_social" id="razon_social" type="text"
                        class="w-full px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-200"
                        placeholder="Razón social completa" />
                    <p v-if="form.errors.razon_social" class="mt-1 text-sm text-rose-600 dark:text-rose-400 font-medium">
                ...
                <div class="md:col-span-2">
                    <label for="regimen_fiscal" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                        Régimen Fiscal (SAT) *
                    ...
                    <p v-if="form.errors.regimen_fiscal" class="mt-1 text-sm text-rose-600 dark:text-rose-400 font-medium">
                ...
                <div class="md:col-span-2">
                    <h3 class="text-md font-medium text-slate-900 dark:text-slate-100 mb-4 flex items-center gap-2 border-b border-slate-200 dark:border-slate-700 pb-2">
                        <FontAwesomeIcon icon="map-marker-alt" class="text-slate-400 dark:text-slate-500" /> Dirección
                    </h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Calle -->
                        <div class="md:col-span-2">
                            <label for="calle" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                                Calle *
                            </label>
                            <input v-model="form.calle" id="calle" type="text"
                                class="w-full px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-200"
                                placeholder="Nombre de la calle" />
                            <p v-if="form.errors.calle" class="mt-1 text-sm text-rose-600 dark:text-rose-400 font-medium">
                                {{ form.errors.calle }}
                            </p>
                        </div>
                        ...
                        <!-- Número Exterior -->
                        <div>
                            <label for="numero_exterior" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                                Número Exterior *
                            </label>
                        ...
                        <!-- Número Interior -->
                        <div>
                            <label for="numero_interior" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                                Número Interior
                            </label>
                        ...
                        <!-- Código Postal -->
                        <div class="md:col-span-2">
                            <label for="codigo_postal" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                                Código Postal *
                            </label>
                            <div class="flex gap-2">
                                ...
                                <button type="button" @click="validarCodigoPostalEmpresa"
                                    class="px-4 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-xl hover:bg-slate-200 dark:hover:bg-slate-600 border border-slate-300 dark:border-slate-700 transition-colors"
                                    title="Buscar CP">
                        ...
                        <!-- Colonia -->
                        <div>
                            <label for="colonia" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                                Colonia *
                            </label>
                        ...
                        <!-- Ciudad -->
                        <div>
                            <label for="ciudad" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                                Ciudad/Municipio *
                            </label>
                        ...
                        <!-- País -->
                        <div>
                            <label for="pais" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                                País *
                            </label>
                ...
                <div class="md:col-span-2 mt-4">
                    <h3 class="text-md font-medium text-slate-900 dark:text-slate-100 mb-4 flex items-center gap-2 border-b border-slate-200 dark:border-slate-700 pb-2">
                        <FontAwesomeIcon icon="address-book" class="text-slate-400 dark:text-slate-500" /> Contacto
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                        ...
                        <div class="md:col-span-2">
                            <label for="sitio_web" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
                                Sitio Web
                            </label>
                ...
                <!-- Descripción -->
                <div class="md:col-span-2 mt-4">
                    <label for="descripcion_empresa" class="block text-sm font-medium text-slate-700 dark:text-slate-200 mb-2">
