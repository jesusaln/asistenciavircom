    ...
    <div class="space-y-8">
        <div>
            <h2 class="text-xl font-semibold text-gray-900 mb-6 flex items-center gap-2">
                <FontAwesomeIcon icon="envelope" class="text-amber-600" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Host -->
                <div>
                    <label for="smtp_host" class="block text-sm font-medium text-gray-700 mb-2">Host SMTP</label>
                    <input v-model="form.smtp_host" id="smtp_host" type="text" placeholder="smtp.ejemplo.com"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 transition-all" />
                </div>

                <!-- Puerto -->
                <div>
                    <label for="smtp_port" class="block text-sm font-medium text-gray-700 mb-2">Puerto</label>
                ...
                <!-- Usuario -->
                <div>
                    <label for="smtp_username" class="block text-sm font-medium text-gray-700 mb-2">Usuario SMTP</label>
                ...
                <!-- Contraseña -->
                <div>
                    <label for="smtp_password" class="block text-sm font-medium text-gray-700 mb-2">Contraseña</label>
                ...
                <!-- Encriptación -->
                <div>
                    <label for="smtp_encryption" class="block text-sm font-medium text-gray-700 mb-2">Encriptación</label>
            ...
            <div class="mt-8 border-t pt-6">
                <h3 class="text-md font-medium text-gray-900 mb-4">Configuración de Remitente</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="email_from_address" class="block text-sm font-medium text-gray-700 mb-2">Correo Remitente</label>
                        <input v-model="form.email_from_address" id="email_from_address" type="email"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 transition-all" />
                    </div>
                    <div>
                        <label for="email_from_name" class="block text-sm font-medium text-gray-700 mb-2">Nombre Remitente</label>
            ...
            <div class="mt-8 p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                <h4 class="text-sm font-medium text-indigo-900 mb-3">Probar configuración</h4>
                <div class="flex gap-2">
                    <input v-model="emailPrueba" type="email" placeholder="correo@prueba.com"
                        class="flex-1 px-4 py-2 border border-indigo-200 rounded-lg focus:ring-2 focus:ring-amber-500" />
