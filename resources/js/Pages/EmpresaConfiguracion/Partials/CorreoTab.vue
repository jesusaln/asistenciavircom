    ...
    <div class="space-y-8">
        <div>
            ...
            <div class="mb-8">
                ...
                <div class="flex flex-wrap gap-2">
                    <button v-for="(prov, key) in proveedoresSMTP" :key="key" type="button" @click="aplicarConfiguracionProveedor(key)"
                        class="px-3 py-2 text-xs font-medium rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-white dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-colors">
                        {{ prov.nombre }}
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input v-model="form.smtp_host" id="smtp_host" type="text" placeholder="smtp.ejemplo.com"
                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200" />
                </div>
            ...
            <div class="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
                <h3 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-4">Configuración de Remitente</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
            ...
            <div class="mt-8 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100 dark:border-indigo-700">
                ...
                <div class="flex gap-2">
                    <input v-model="emailPrueba" type="email" placeholder="correo@prueba.com"
                        class="flex-1 px-4 py-2 border border-indigo-200 dark:border-indigo-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200" />
