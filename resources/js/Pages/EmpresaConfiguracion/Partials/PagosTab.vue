    ...
    <div class="space-y-8">
        <div>
            <h2 class="text-xl font-semibold text-gray-900 mb-6 flex items-center gap-2">
                <FontAwesomeIcon icon="money-bill-wave" class="text-gray-700" />
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-200 mb-6">
                <h3 class="text-md font-medium text-gray-900 mb-4">Reporte de Pagos a Proveedores por Email</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        >
                        <p class="text-xs text-gray-500 mt-1">El reporte incluirá: proveedor, monto adeudado y días de vencimiento</p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex items-center gap-3">
                        <input 
                            ...
                            min="0"
                            max="30"
                            class="w-24 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500"
                        >
            ...
            <div class="bg-orange-50 p-4 rounded-xl border border-orange-200">
                <h4 class="text-sm font-medium text-orange-900 mb-2 flex items-center gap-2">
                    <FontAwesomeIcon icon="info-circle" />
                    ¿Qué incluye el reporte?
                </h4>
                <ul class="text-sm text-orange-800 list-disc list-inside space-y-1">
