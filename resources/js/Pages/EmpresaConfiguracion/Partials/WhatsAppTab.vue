        ...
        <div>
            ...
            <div class="flex items-center mb-6">
                 <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-100">Habilitar integración con WhatsApp</span>
                </label>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Business Account ID -->
                     <div>
                        ...
                        <input v-model="form.whatsapp_business_account_id" id="whatsapp_business_account_id" type="text"
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all font-mono text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200" />
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea v-model="form.whatsapp_access_token" id="whatsapp_access_token" rows="2"
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all font-mono text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200" placeholder="EAAG..."></textarea>
                    </div>
