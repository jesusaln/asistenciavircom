  ...
  <div class="space-y-6">
    <header class="mb-6">
      <h2 class="text-xl font-semibold text-gray-800 flex items-center">
        <FontAwesomeIcon icon="globe" class="mr-3 text-blue-600" />
    ...
    <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          />
          <p class="text-xs text-gray-500 mt-1">Dominio principal del sistema</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
          />
          <p class="text-xs text-gray-500 mt-1">Dominio alternativo o secundario</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
          />
          <p class="text-xs text-gray-500 mt-1">URL base completa (con https://)</p>
        </div>
        ...
        <div class="flex items-center">
          <label class="relative inline-flex items-center cursor-pointer">
            ...
            <span class="ms-3 text-sm font-medium text-gray-700">Forzar HTTPS</span>
          </label>
        </div>
      </div>
    </div>
    ...
    <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          />
          <p class="text-xs text-gray-500 mt-1">Dirección IPv4 del servidor</p>
        </div>
        ...
        <div>
          ...
          />
          <p class="text-xs text-gray-500 mt-1">Dirección IPv6 del servidor (opcional)</p>
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="flex items-center col-span-2">
          <label class="relative inline-flex items-center cursor-pointer">
            ...
            <span class="ms-3 text-sm font-medium text-gray-700">SSL Habilitado</span>
          </label>
          <span v-if="form.ssl_enabled" class="ml-4 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
        ...
        <div class="col-span-2">
          ...
          <input
            ...
            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 font-mono text-sm"
          />
          <p class="text-xs text-gray-500 mt-1">Archivo de cadena de certificados (opcional)</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-orange-50 rounded-lg p-6 border border-orange-200">
      <h3 class="text-md font-semibold text-gray-700 mb-4 flex items-center">
        ...
        ZeroTier VPN
        <span class="ml-2 text-xs bg-orange-100 text-orange-700 px-2 py-0.5 rounded-full">Acceso sin abrir puertos</span>
      </h3>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="flex items-center col-span-2">
          <label class="relative inline-flex items-center cursor-pointer">
            ...
            <span class="ms-3 text-sm font-medium text-gray-700">Habilitar ZeroTier</span>
          </label>
          <span v-if="form.zerotier_enabled" class="ml-4 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
            <FontAwesomeIcon icon="check-circle" class="mr-1" />
            VPN Activa
          </span>
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxlength="16"
            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 font-mono tracking-wider"
          />
          <p class="text-xs text-gray-500 mt-1">ID de 16 caracteres de tu red ZeroTier</p>
        </div>
        ...
        <div>
          ...
          />
          <p class="text-xs text-gray-500 mt-1">IP asignada a este servidor en la red ZeroTier</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 font-mono"
          />
          <p class="text-xs text-gray-500 mt-1">Identificador del nodo ZeroTier</p>
        </div>
        ...
        <div>
          ...
          <div class="flex items-center">
            <input
              ...
              type="text"
              readonly
              class="w-full rounded-lg border-gray-300 bg-gray-100 shadow-sm font-mono text-sm"
            />
            <button 
              v-if="zerotierUrl"
    ...
    <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
      <div class="flex">
        <FontAwesomeIcon icon="info-circle" class="text-blue-500 mt-1 mr-3" />
        <div>
          <h4 class="text-sm font-medium text-blue-800">Configuración DNS</h4>
