    ...
    <div class="space-y-8">
        <div>
            <h2 class="text-xl font-semibold text-gray-900 mb-6 flex items-center gap-2">
                <FontAwesomeIcon icon="cloud-upload-alt" class="text-blue-600" />
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-200 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                        ...
                        <div class="font-medium text-gray-900">Sin Cloud</div>
                        <div class="text-xs text-gray-500">Solo respaldos locales</div>
                    </button>
                    ...
                    <button
                        ...
                        :class="[
                            'p-4 rounded-xl border-2 text-left transition-all',
                            form.cloud_provider === 'gdrive' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-300'
                        ]"
                    >
                        ...
                        <div class="text-xs text-gray-500">15 GB gratis, API estable</div>
                    </button>
                </div>
            </div>

            <!-- Configuración Google Drive -->
            <div v-if="form.cloud_provider === 'gdrive'" class="bg-white p-6 rounded-xl border border-gray-200 mb-6">
                ...
                <div v-if="!gdriveConnected" class="text-center py-8">
                    ...
                    <p class="text-gray-600 mb-6">Conecta tu cuenta de Google Drive para respaldar automáticamente</p>
                    ...
                    >
                        ...
                        <FontAwesomeIcon v-if="connecting" icon="spinner" spin class="text-gray-400" />
                    </button>
                </div>
                ...
                <div v-else class="space-y-6">
                    <div class="bg-green-50 border border-green-200 rounded-2xl p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-4">
                                <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center border-4 border-white shadow-sm">
                                    <FontAwesomeIcon icon="check" class="text-green-600 text-xl" />
                                </div>
                                <div>
                                    <div class="text-green-800 font-bold text-lg">¡Conexión Exitosa!</div>
                            ...
                            <button 
                                ...
                                class="px-4 py-2 text-sm font-medium text-red-600 bg-white border border-red-200 hover:bg-red-50 rounded-xl transition-all shadow-sm"
                            >
                        ...
                        <div class="text-xs text-green-700 bg-green-100/50 p-2 rounded-lg inline-block">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t">
                        ...
                        <div class="flex items-end">
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <span class="ml-3 text-sm font-medium text-gray-900">Auto-subir respaldos</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t">
                        <div class="flex items-center justify-between mb-3">
                            <h4 class="font-medium text-gray-700">Respaldos en Google Drive</h4>
                            <button @click="loadGDriveBackups" class="text-sm text-blue-600 hover:underline">
                                <FontAwesomeIcon icon="sync" :spin="loadingBackups" /> Actualizar
                            </button>
                        </div>
                        
                        <div v-if="loadingBackups" class="text-center py-4 text-gray-500">
                            <FontAwesomeIcon icon="spinner" spin /> Cargando...
                        </div>
                        <div v-else-if="gdriveFiles.length === 0" class="text-center py-4 text-gray-500">
                        ...
                        <div v-else class="space-y-2 max-h-48 overflow-y-auto">
                            ...
                            >
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm font-medium" :class="index < 3 ? 'text-blue-900' : 'text-gray-700'">{{ file.name }}</span>
                                ...
                                <div class="flex gap-1">
                                    <button @click="downloadFile(file.id)" class="p-1 text-blue-600 hover:bg-blue-100 rounded" title="Descargar">
                                        <FontAwesomeIcon icon="download" />
                                    </button>
                                    <button 
                                        @click="deleteFile(file.id)" 
                                        class="p-1 rounded transition-colors"
                                        :class="index < 3 ? 'text-gray-300 cursor-not-allowed' : 'text-red-600 hover:bg-red-50'"
            ...
            <!-- Mensajes -->
            <div v-if="errorMessage" class="p-4 bg-red-50 border border-red-200 rounded-lg text-red-700 mb-4">
                {{ errorMessage }}
            </div>
            <div v-if="successMessage" class="p-4 bg-green-50 border border-green-200 rounded-lg text-green-700 mb-4">
                {{ successMessage }}
            </div>
        </div>
    </div>
