        ...
        <div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                        <img src="https://www.gstatic.com/images/branding/product/1x/drive_2020q4_48dp.webp" class="w-8 h-8 mb-2" alt="Google Drive">
            ...
            <div v-if="form.cloud_provider === 'gdrive'" class="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 mb-6">
                <h3 class="text-md font-medium text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
                    <img src="https://www.gstatic.com/images/branding/product/1x/drive_2020q4_48dp.webp" class="w-6 h-6" alt="">
                    Google Drive
                </h3>

                <!-- Configuración de la Aplicación -->
                <div v-if="!gdriveConnected" class="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-xl border border-blue-100 dark:border-blue-900/30 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-[10px] uppercase tracking-wider font-bold text-gray-500 dark:text-gray-400 mb-1">Client ID</label>
                            <input 
                                type="text" 
                                v-model="form.gdrive_client_id"
                                class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400"
                                placeholder="821...apps.googleusercontent.com"
                            >
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase tracking-wider font-bold text-gray-500 dark:text-gray-400 mb-1">Client Secret</label>
                            <input 
                                type="password" 
                    ...
                    <div class="mt-3 flex items-start gap-2">
                        ...
                        <div class="text-[10px] text-gray-600 dark:text-gray-400 leading-normal">
                            Debes configurar estos valores antes de conectar. En Google Cloud Console, agrega esta URI de redirección:
                            <div class="mt-1 bg-white dark:bg-gray-800 p-1.5 rounded border border-blue-100 dark:border-blue-900/30 font-mono text-blue-700 dark:text-blue-400 select-all truncate">
                                {{ redirectUri }}
                            </div>
                        </div>
                    </div>
                    <div class="mt-4 text-center">
                        <p class="text-[10px] text-gray-500 mb-2">Una vez ingresados, guarda los cambios antes de conectar:</p>
                        <button 
                            @click="$emit('save')"
                            class="text-xs bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 px-3 py-1.5 rounded hover:bg-blue-200 transition-colors"
                        >
                ...
                <div v-if="!gdriveConnected" class="text-center py-8">
                    ...
                    >
                        <img src="https://www.gstatic.com/images/branding/product/1x/gsa_512dp.webp" class="w-5 h-5" alt="">
