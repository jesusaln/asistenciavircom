...
<template>
    <div class="space-y-8">
        ...
        <div class="border-b border-gray-100 dark:border-gray-700 pb-6">
            ...
            <p class="mt-2 text-gray-500 dark:text-gray-400">Configura el asistente virtual impulsado por IA para atención a clientes</p>
        </div>
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Proveedor de IA</label>
            ...
            <div v-if="connectionStatus" class="mt-4">
                <div 
                    :class="[
                        ...
                        connectionStatus.success ? 'bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300' : 'bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300'
                    ]"
                >
        ...
        <!-- Info Card -->
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-700 rounded-xl p-6">
