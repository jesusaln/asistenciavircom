    ...
    <div class="space-y-8">
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Logos -->
                <div class="space-y-6">
                    <h3 class="text-md font-medium text-gray-900 dark:text-white dark:text-gray-100 border-b border-gray-200 dark:border-slate-800 dark:border-gray-700 pb-2">Logotipos</h3>
                    
                    <!-- Logo Principal -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Logo Principal</label>
                         <div class="mt-1 flex items-center gap-4">
                            <div class="w-24 h-24 border dark:border-gray-600 rounded-lg flex items-center justify-center bg-white dark:bg-slate-900 dark:bg-gray-700 overflow-hidden">
                            ...
                            <div class="flex-1">
                                <input type="file" @change="handleLogoChange" accept="image/*" class="block w-full text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 mb-2" />
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">Recomendado: 200x200px PNG transparente.</p>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Favicon</label>
                         <div class="mt-1 flex items-center gap-4">
                            <div class="w-12 h-12 border dark:border-gray-600 rounded-lg flex items-center justify-center bg-white dark:bg-slate-900 dark:bg-gray-700 overflow-hidden">
                             ...
                             <div class="flex-1">
                                <input type="file" @change="handleFaviconChange" accept="image/*" class="block w-full text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 mb-2" />
                                <div class="flex gap-2">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">Imagen pequeña que aparece en la pestaña del navegador (32x32px).</p>
                    </div>
                </div>

                <!-- Colores -->
                <div class="space-y-6">
                    <h3 class="text-md font-medium text-gray-900 dark:text-white dark:text-gray-100 border-b border-gray-200 dark:border-slate-800 dark:border-gray-700 pb-2">Identidad de Color</h3>
                    ...
                    <div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <input v-model="form.color_principal" type="text" class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 uppercase bg-white dark:bg-slate-900 dark:bg-gray-700 text-gray-900 dark:text-white dark:text-gray-200" maxlength="7" />
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">Usado en encabezados, botones principales y énfasis.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <input v-model="form.color_secundario" type="text" class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 uppercase bg-white dark:bg-slate-900 dark:bg-gray-700 text-gray-900 dark:text-white dark:text-gray-200" maxlength="7" />
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">Usado en elementos decorativos y fondos sutiles.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <input v-model="form.color_terciario" type="text" class="flex-1 rounded-lg border-gray-300 dark:border-gray-600 uppercase bg-white dark:bg-slate-900 dark:bg-gray-700 text-gray-900 dark:text-white dark:text-gray-200" maxlength="7" />
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">Usado en notas informativas y elementos de soporte.</p>
                    </div>

                    <div class="bg-white dark:bg-slate-900 dark:bg-gray-700 p-4 rounded-lg border border-gray-200 dark:border-slate-800 dark:border-gray-600">
                        <h4 class="text-sm font-semibold text-gray-900 dark:text-white dark:text-gray-100 mb-2">Vista Previa</h4>
