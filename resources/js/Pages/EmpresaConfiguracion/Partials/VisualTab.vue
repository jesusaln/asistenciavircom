    ...
    <div class="space-y-8">
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Logos -->
                <div class="space-y-6">
                    <h3 class="text-md font-medium text-gray-900 border-b pb-2">Logotipos</h3>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Logo Principal</label>
                         <div class="mt-1 flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <input type="file" @change="handleLogoChange" accept="image/*" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 mb-2" />
                                <div class="flex gap-2">
                                     <button v-if="logoForm.logo" @click="subirLogo" type="button" class="text-xs bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">Subir</button>
                                     <button v-if="form.logo_url" @click="eliminarLogo" type="button" class="text-xs bg-red-100 text-red-600 px-3 py-1 rounded hover:bg-red-200">Borrar Actual</button>
                                </div>
                            </div>
                        </div>
                        <p class="text-xs text-gray-500 mt-1">Recomendado: 200x200px PNG transparente.</p>
                    </div>
                        ...
                        <label class="block text-sm font-medium text-gray-700 mb-2">Favicon</label>
                         <div class="mt-1 flex items-center gap-4">
                            <div class="w-12 h-12 border rounded-lg flex items-center justify-center bg-gray-50 overflow-hidden">
                             ...
                             <div class="flex-1">
                                <input type="file" @change="handleFaviconChange" accept="image/*" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 mb-2" />
                                <div class="flex gap-2">
                                     <button v-if="faviconForm.favicon" @click="subirFavicon" type="button" class="text-xs bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">Subir</button>
                                      <button v-if="form.favicon_url" @click="eliminarFavicon" type="button" class="text-xs bg-red-100 text-red-600 px-3 py-1 rounded hover:bg-red-200">Borrar</button>
                                </div>
                            </div>
                        </div>
                        <p class="text-xs text-gray-500 mt-1">Imagen pequeña que aparece en la pestaña del navegador (32x32px).</p>
                    </div>
                </div>

                <!-- Colores -->
                <div class="space-y-6">
                    <h3 class="text-md font-medium text-gray-900 border-b pb-2">Identidad de Color</h3>
                    ...
                    <div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <input v-model="form.color_principal" type="text" class="flex-1 rounded-lg border-gray-300 uppercase" maxlength="7" />
                        </div>
                        <p class="text-xs text-gray-500 mt-1">Usado en encabezados, botones principales y énfasis.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <input v-model="form.color_secundario" type="text" class="flex-1 rounded-lg border-gray-300 uppercase" maxlength="7" />
                        </div>
                        <p class="text-xs text-gray-500 mt-1">Usado en elementos decorativos y fondos sutiles.</p>
                    </div>

                    <div>
                        <label for="color_terciario" class="block text-sm font-medium text-gray-700 mb-2">Color Terciario / Alertas</label>
                        <div class="flex gap-3">
                            ...
                            <input v-model="form.color_terciario" type="text" class="flex-1 rounded-lg border-gray-300 uppercase" maxlength="7" />
                        </div>
