...
<template>
  ...
  <div class="min-h-screen bg-slate-950 py-12 px-4 selection:bg-blue-500/30">
    <div class="max-w-4xl mx-auto">
        <div class="bg-slate-900 border border-white/10 rounded-3xl p-8 shadow-2xl overflow-hidden relative group">
            ...
            <div class="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                <div>
                     <div class="inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-4">
                ...
                <div class="flex flex-wrap items-center gap-3 justify-end">
                    <a
                      ...
                      class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#25D366] hover:bg-[#20bd5a] text-white text-xs font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-emerald-900/30 transition-all active:scale-95"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      class="inline-flex items-center gap-2 px-6 py-4 bg-slate-700 hover:bg-slate-600 text-white text-xs font-black uppercase tracking-widest rounded-2xl border border-white/10"
                    >
                      Descargar PDF
                    </a>
                    <button type="button" class="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white text-xs font-black uppercase tracking-widest rounded-2xl shadow-xl shadow-blue-600/20 transition-all active:scale-95" @click="generarPDF">
                        Imprimir Recibo
                    </button>
                    <Link :href="`/pagos/${pago.id}`" class="px-6 py-4 bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-black uppercase tracking-widest rounded-2xl transition-all">
                        Volver
                    </Link>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div class="bg-slate-950/50 rounded-2xl p-6 border border-white/5">
                    <h3 class="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4">Resumen de Pago</h3>
                    <div class="space-y-4">
                ...
                <div class="bg-slate-950/50 rounded-2xl p-6 border border-white/5">
                    <h3 class="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4">Referencia del Crédito</h3>
                    <div class="space-y-4">
            ...
            <div class="bg-blue-600/5 border border-blue-500/10 rounded-2xl p-4 flex items-center gap-4">
                ...
                <div>
                    <div class="text-[10px] font-black text-blue-400 uppercase tracking-widest">Saldo Actualizado</div>
