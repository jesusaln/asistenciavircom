...
<template>
  ...
  <div class="pagos-edit min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-indigo-500/30">
        ...
        <div class="flex items-center gap-6">
           <div class="relative group">
              ...
              <div class="relative w-16 h-16 rounded-2xl bg-slate-900 border border-white/10 flex items-center justify-center shadow-2xl backdrop-blur-xl">
                 <svg class="w-8 h-8 text-amber-400 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
           ...
           <div>
              <h1 class="text-4xl font-black text-white tracking-tighter mb-1 uppercase">
                Modificar <span class="bg-clip-text text-transparent bg-gradient-to-r from-amber-400 to-orange-400">Pago</span>
              </h1>
              <p class="text-slate-500 text-sm font-bold uppercase tracking-widest">Edición de registros históricos de cobranza</p>
           </div>
        </div>
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <input
                      ...
                      step="0.01"
                      min="0"
                      class="block w-full pl-8 pr-3 py-3 bg-slate-950 border rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-white font-bold placeholder-slate-600 transition-all border-white/10"
                      :class="errors.monto_pagado ? 'border-rose-500/50 focus:ring-rose-500' : ''"
                    />
                  </div>
