    ...
    <div class="w-full px-6 py-8">
      ...
      <div class="mb-8 flex items-center justify-between">
        <div class="flex items-center space-x-4">
          ...
          <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ empleado.user?.name || 'Empleado' }}</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ empleado.numero_empleado }} • {{ empleado.puesto || 'Sin puesto' }}</p>
          </div>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                <p class="text-sm text-gray-500 dark:text-gray-400">NSS</p>
          ...
          <!-- Datos Laborales -->
          <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Información Laboral</h2>
            <div class="grid grid-cols-2 gap-4">
              <div>
              ...
              <div>
                <p class="text-sm text-gray-500 dark:text-gray-400">Fecha de Contratación</p>
              ...
              <div>
                <p class="text-sm text-gray-500 dark:text-gray-400">Salario Base</p>
          ...
          <!-- Datos Bancarios -->
          <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Información Bancaria</h2>
            <div class="grid grid-cols-3 gap-4">
              ...
              <div>
                <p class="text-sm text-gray-500 dark:text-gray-400">CLABE</p>
          ...
          <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 p-6">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Contacto de Emergencia</h2>
            <div class="grid grid-cols-3 gap-4">
              <div>
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center justify-between mb-4">
              <h3 class="font-semibold text-gray-900 dark:text-white">Nóminas Recientes</h3>
            ...
            <div v-if="nominasRecientes.length" class="space-y-3">
              <div v-for="nomina in nominasRecientes.slice(0, 5)" :key="nomina.id" class="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                <div>
                  <p class="text-sm font-medium text-gray-900 dark:text-white">{{ nomina.periodo_formateado }}</p>
                  <p class="text-xs text-gray-500 dark:text-gray-400">{{ nomina.tipo_periodo_formateado }}</p>
                </div>
          ...
          <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
              <div class="p-4 bg-white dark:bg-slate-900 rounded-lg border border-gray-100">
                <div class="flex items-center justify-between mb-2">
                  <span class="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Contrato Laboral</span>
          ...
          <!-- Observaciones -->
          <div v-if="empleado.observaciones" class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Observaciones</h3>
            <p class="text-sm text-gray-600 dark:text-gray-300">{{ empleado.observaciones }}</p>
          </div>
        </div>
      </div>
    </div>
