    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-12 gap-10">
        ...
        <div class="xl:col-span-8 space-y-10">
          ...
          <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-gray-100 dark:border-slate-800 overflow-hidden group transition-all">
          ...
          <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-gray-100 dark:border-slate-800 overflow-hidden">
             <div class="px-8 py-5 border-b border-gray-100 dark:border-slate-800/50 bg-gray-50/50 dark:bg-slate-950/20">
                <h2 class="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest">Observaciones Adicionales</h2>
             </div>
             <div class="p-8">
                <textarea v-model="form.notas" rows="4" class="w-full bg-gray-50 dark:bg-slate-950 border-2 border-gray-100 dark:border-slate-800 focus:border-blue-500 rounded-2xl px-6 py-4 text-sm font-bold text-gray-900 dark:text-white outline-none transition-all placeholder-gray-400 dark:placeholder-slate-600" placeholder="Escribe notas internas o para el cliente..."></textarea>
             </div>
          </div>
        </div>
             ...
             <div class="p-8 space-y-6">
                <div class="space-y-4">
                   <div class="flex justify-between items-center text-xs font-bold">
                      ...
                      <span class="text-gray-900 dark:text-white">${{ totales.subtotal.toFixed(2) }}</span>
                   </div>
                   <div class="flex justify-between items-center text-xs font-bold text-rose-500">
                    ...
                    <div class="flex flex-col gap-2 pt-2">
                       ...
                       <input type="number" v-model="form.descuento_general" class="w-full bg-gray-50 dark:bg-slate-950 border-2 border-gray-100 dark:border-slate-800 rounded-xl px-4 py-2 text-sm font-black text-gray-900 dark:text-white outline-none" />
                    </div>
                </div>
                ...
                <div class="pt-6 border-t border-gray-100 dark:border-slate-800/50 space-y-4">
                    <div class="flex justify-between items-center text-xs font-bold">
                      ...
                      <span class="text-gray-900 dark:text-white">${{ totales.iva.toFixed(2) }}</span>
                   </div>
