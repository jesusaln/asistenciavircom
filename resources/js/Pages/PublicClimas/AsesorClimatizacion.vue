                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                                        ...
                                        :class="['p-6 rounded-[2rem] border-2 transition-all duration-300 text-center flex flex-col items-center', 
                                            ...
                                            <span class="text-4xl mb-4 transform group-hover:scale-110 transition-transform"><font-awesome-icon :icon="h.icon" /></span>
                                ...
                                <div class="pt-8 border-t border-gray-100">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                                        <button @click="form.zona = 'centro'" 
                                            ...
                                            <div class="text-4xl mb-6 transform group-hover:scale-110 transition-transform"><font-awesome-icon icon="building" /></div>
                                        ...
                                        <button @click="form.zona = 'costa'" 
                                            ...
                                            <div class="text-4xl mb-6 transform group-hover:scale-110 transition-transform"><font-awesome-icon icon="globe-americas" /></div>
                                        ...
                                        <button @click="form.zona = 'desierto'" 
                                            ...
                                            <div class="text-4xl mb-6 transform group-hover:scale-110 transition-transform"><font-awesome-icon icon="map-marker-alt" /></div>
                                ...
                                <div class="text-center md:w-full py-6">
                                    ...
                                    <div v-if="form.tecnologia === 'inverter'" class="bg-green-50 border border-green-100 rounded-[2rem] p-8 mb-10 group">
                                        <div class="flex items-center gap-6">
                                            <div class="text-4xl group-hover:scale-110 transition-transform"><font-awesome-icon icon="dollar-sign" /></div>
                                            <div class="text-left">
