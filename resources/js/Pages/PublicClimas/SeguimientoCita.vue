...
const estadoInfo = computed(() => {
    const estados = {
        ...
        'en_proceso': { label: 'En Proceso', color: 'indigo', icon: 'tools' },
        ...
        <main class="w-full px-4 py-6 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div v-if="cita?.esta_confirmada" class="p-4 bg-green-50 border border-green-200 rounded-xl">
                        <p class="font-bold text-green-800 mb-2"><font-awesome-icon icon="calendar-alt" class="mr-1" /> Cita Confirmada</p>
                    ...
                    <div v-else class="p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
                        <p class="font-bold text-yellow-800 mb-2"><font-awesome-icon icon="hourglass-half" class="mr-1" /> Esperando Confirmación</p>
                    ...
                    <div v-if="cita?.tecnico" class="flex items-center gap-3 p-4 bg-white rounded-xl">
                        ...
                        <div>
                            ...
                            <p v-if="cita.tecnico.telefono" class="text-sm text-gray-500"><font-awesome-icon icon="phone" class="mr-1" /> {{ cita.tecnico.telefono }}</p>
                        </div>
                    </div>
                    
                    <!-- Dirección -->
                    <div class="p-4 bg-white rounded-xl">
                        <p class="text-sm text-gray-500 mb-1"><font-awesome-icon icon="map-marker-alt" class="mr-1" /> Dirección del servicio</p>
                    ...
                    <!-- Servicio -->
                    <div class="p-4 bg-white rounded-xl">
                        <p class="text-sm text-gray-500 mb-1"><font-awesome-icon icon="tools" class="mr-1" /> Servicio solicitado</p>
            ...
            <div v-if="cargos && cargos.items.length > 0" class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-bold text-gray-900"><font-awesome-icon icon="dollar-sign" class="mr-1" /> Estado de Cuenta</h3>
                    <span 
                        :class="[
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <h3 class="font-bold text-gray-900 mb-4"><font-awesome-icon icon="clipboard-list" class="mr-1" /> Estado de tu solicitud</h3>
