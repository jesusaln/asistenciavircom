                ...
                <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="text-center p-5 bg-gradient-to-r from-orange-50 to-amber-50 border-2 border-orange-200 rounded-2xl">
                            <p class="text-sm text-orange-700 font-medium mb-1"><font-awesome-icon icon="id-card" class="mr-1" /> Tu número de solicitud</p>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                            <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                                <span class="text-xl"><font-awesome-icon icon="envelope" /></span>
                            </div>
                            <div>
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-2xl p-4">
                            <p class="font-semibold text-amber-800 mb-2"><font-awesome-icon icon="clipboard-list" class="mr-1" /> ¿Qué sigue?</p>
