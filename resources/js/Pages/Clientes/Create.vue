    ...
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-xl dark:shadow-none rounded-2xl p-8 border border-gray-100 dark:border-gray-700">
      ...
      <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Crear Nuevo Cliente</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Complete los datos para registrar un nuevo cliente</p>
          </div>
        </div>
