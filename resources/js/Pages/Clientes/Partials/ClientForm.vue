<template>
  <div class="space-y-8">
    ...
    <div class="border-b border-gray-200 pb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="md:col-span-2">
          <div class="mb-4">
            ...
            <div
              ...
              class="mt-1 text-xs text-blue-600 bg-blue-50 p-2 rounded border border-blue-100 italic"
            >
        ...
        <div class="mb-4">
          <label for="password" class="block text-sm font-medium text-gray-700">
            ...
            <span class="text-gray-400">({{ isEdit ? 'dejar vacío para mantener actual' : 'opcional' }})</span>
          </label>
          <input
            type="password"
            id="password"
        ...
        <div class="mb-4">
          ...
          <div class="mt-3 flex items-center">
            ...
            />
            <label for="whatsapp_optin" class="ml-2 block text-sm text-gray-700">
      ...
      <!-- Lista de Precios -->
      <div class="mb-6">
        <label for="price_list_id" class="block text-sm font-medium text-gray-700">
        ...
        <select
          ...
          :class="[
                'mt-1 block w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm',
                form.errors.price_list_id ? 'border-red-300 bg-red-50' : 'border-gray-300'
              ]"
          required
        >
        ...
        <div v-if="form.errors.price_list_id" class="mt-2 text-sm text-red-600">
    ...
    <!-- Gestión de Crédito -->
    <div class="border-b border-gray-200 pb-6">
      <h2 class="text-lg font-medium text-gray-900 mb-4">Gestión de Crédito</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="mb-4">
          <label class="inline-flex items-center">
            <input
              ...
              class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            />
            <span class="ml-2 text-sm font-medium text-gray-700">Habilitar Crédito</span>
          </label>
          <p class="mt-1 text-xs text-gray-500">
        ...
        <div v-if="form.credito_activo" class="mb-4">
          ...
          <div v-if="form.errors.limite_credito" class="mt-2 text-sm text-red-600">
            {{ form.errors.limite_credito }}
          </div>
        </div>

        <div v-if="form.credito_activo" class="mb-4">
          <label for="dias_credito" class="block text-sm font-medium text-gray-700">
            Días de Crédito
          </label>
          <div class="mt-1 relative rounded-md shadow-sm">
            <input
          ...
          <div v-if="form.errors.dias_credito" class="mt-2 text-sm text-red-600">
    ...
    <div v-if="form.requiere_factura" class="border-b border-gray-200 pb-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="mb-4">
         ...
         <div class="mb-4">
          <label for="forma_pago_default" class="block text-sm font-medium text-gray-700">
            Forma de Pago Preferida <span class="text-gray-400">(opcional)</span>
          </label>
          <select
            ...
            :class="[
              'mt-1 block w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm',
              form.errors.forma_pago_default ? 'border-red-300 bg-red-50' : 'border-gray-300',
          ...
          <div v-if="form.errors.forma_pago_default" class="mt-2 text-sm text-red-600">
            {{ form.errors.forma_pago_default }}
          </div>
        </div>

        <div class="mb-4">
          <label for="domicilio_fiscal_cp" class="block text-sm font-medium text-gray-700">
          ...
          <input
            ...
            :class="[
                  'mt-1 block w-full rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm',
                  form.errors.domicilio_fiscal_cp ? 'border-red-300 bg-red-50' : 'border-gray-300',
                  !form.requiere_factura ? 'bg-gray-100 text-gray-400' : ''
                ]"
          />
          <div v-if="form.errors.domicilio_fiscal_cp" class="mt-2 text-sm text-red-600">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="md:col-span-2">
          <div class="mb-4">
            <label for="calle" class="block text-sm font-medium text-gray-700">
              Calle <span class="text-gray-400">(opcional)</span>
            </label>
            <input
              type="text"
              id="calle"
        ...
        <div class="mb-4">
          <label for="numero_exterior" class="block text-sm font-medium text-gray-700">
            Número Exterior <span class="text-gray-400">(opcional)</span>
          </label>
          <input
            type="text"
            id="numero_exterior"
        ...
        <div class="mb-4">
          <label for="codigo_postal" class="block text-sm font-medium text-gray-700">
            Código Postal <span class="text-gray-400">(opcional)</span>
          </label>
          <input
            type="text"
            id="codigo_postal"
        ...
        <div class="mb-4">
          <label for="colonia" class="block text-sm font-medium text-gray-700">
            Colonia <span class="text-gray-400">(opcional)</span>
          </label>
          <select
            id="colonia"
