    ...
    <div class="w-full">
        <div class="bg-white dark:bg-slate-900 shadow-sm rounded-lg">
            ...
            <div class="border-b border-gray-200 dark:border-slate-800 px-6 py-4">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Crear Producto</h1>
                <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">Complete la información del producto</p>
...
const obtenerSiguienteCodigo = async () => {
    ...
    try {
        ...
        console.log('Siguiente código obtenido:', data.data.siguiente_codigo);
