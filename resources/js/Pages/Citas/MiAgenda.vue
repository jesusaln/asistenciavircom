...
function getEstadoInfo(estado) {
    ...
    return estados[estado] || { label: estado, bg: 'bg-gray-100 dark:bg-gray-700', text: 'text-gray-800 dark:text-gray-300', icon: '❓' };
}
...
<template>
    ...
    <AppLayout>
        <div class="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 py-6 transition-colors">
            <div class="w-full px-4">
                ...
                <div class="space-y-4">
                    ...
                    >
                        ...
                        <!-- Acciones -->
                        <div v-if="!['completado', 'cancelado'].includes(cita.estado)" class="px-4 py-3 border-t border-gray-100 dark:border-gray-700 flex gap-2 transition-colors">
                            <button 
                        ...
                        <div v-if="cita.estado === 'completado'" class="border-t border-green-100 dark:border-green-800 bg-green-50 dark:bg-green-900/20 transition-colors">
                            ...
                            <div v-if="cita.trabajo_realizado || cita.fotos_finales" class="p-4 space-y-3">
                                ...
                                <div v-if="cita.fotos_finales?.length > 0">
                                    <div class="text-[10px] font-bold text-green-700 dark:text-green-400 uppercase mb-2 transition-colors">Evidencias:</div>
                                    <div class="grid grid-cols-4 gap-2">
                                        <div v-for="(foto, idx) in cita.fotos_finales" :key="idx" class="aspect-square rounded-lg overflow-hidden border border-green-200 dark:border-green-700">
                ...
                <div class="flex min-h-full items-center justify-center">
                    ...
                    <div class="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-300 transition-colors">
                        ...
                        <div class="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                            <!-- Descripción -->
                            <div>
                                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 uppercase tracking-wider transition-colors">
                            ...
                            <div v-if="citaActiva?.ticket_id" class="p-4 bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-100 dark:border-indigo-800 rounded-2xl transition-colors">
                                <label class="flex items-center gap-3 cursor-pointer">
                                    <input 
                                        type="checkbox" 
                                        v-model="formCierre.cerrar_ticket"
                                        class="h-5 w-5 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500 dark:bg-gray-800"
                                    >
                                    <div class="flex-1">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-3 gap-3">
                                    ...
                                    <div 
                                        ...
                                        :key="index"
                                        class="relative aspect-square rounded-2xl overflow-hidden group shadow-sm bg-gray-100 dark:bg-gray-700"
                                    >
                        ...
                        <div class="p-6 bg-gray-50 dark:bg-gray-900 border-t border-gray-100 dark:border-gray-700 flex gap-3 transition-colors">
                            ...
                            <button 
                                ...
                                class="flex-[2] py-3 bg-indigo-600 text-white font-bold text-sm uppercase tracking-widest rounded-2xl shadow-lg shadow-indigo-200 dark:shadow-indigo-900/30 hover:bg-indigo-700 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                            >
                    ...
                    <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-sm p-6 text-center transition-colors">
                        ...
                        <div class="flex gap-3">
                            <button 
                                ...
                                class="flex-1 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl font-medium hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
                            >
                                Cancelar
                            </button>
                            <button 
