...
<template>
    ...
    <div class="min-h-screen bg-white dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100 overflow-x-hidden selection:bg-[var(--color-primary-soft)] selection:text-[var(--color-primary)] relative transition-colors duration-300">
            ...
            <div class="w-full px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div :class="{'translate-x-0 opacity-100': isVisible, '-translate-x-12 opacity-0': !isVisible}" class="transition-all duration-1000 ease-out">
                        ...
                        <div class="mt-10 p-6 bg-white dark:bg-gray-800/50 backdrop-blur-xl rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl">
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                <div>
                                    <h3 class="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest">Solicita tu Cotización</h3>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 font-medium">Te contactamos en menos de 1 hora</p>
                                </div>
                            </div>

                            <!-- Mensaje de éxito -->
                            <div v-if="contactFormSent" class="mb-4 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 flex items-center gap-2">
                                <svg class="w-5 h-5 text-emerald-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span class="text-xs font-bold text-emerald-700 dark:text-emerald-300">¡Mensaje enviado! Te contactaremos pronto.</span>
                            </div>

                            <!-- Error -->
                            <div v-if="contactFormError" class="mb-4 p-3 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 flex items-center gap-2">
                                <svg class="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span class="text-xs font-bold text-red-700 dark:text-red-300">{{ contactFormError }}</span>
                            </div>
                            ...
                            <form @submit.prevent="submitContactForm" class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <input
                                        ...
                                        class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl text-sm font-medium text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all"
                                        required
                                    />
                                    <input
                                ...
                                <select
                                    ...
                                    class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl text-sm font-medium text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all cursor-pointer"
                                >
                                ...
                                <textarea
                                    ...
                                    class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl text-sm font-medium text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-600 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all resize-none"
                                ></textarea>
                                ...
                                <button
                                    ...
                                    class="w-full py-4 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-xl font-black text-xs uppercase tracking-widest shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0 flex items-center justify-center gap-2"
                                >
                    ...
                    <div :class="{'translate-y-0 opacity-100': isVisible, 'translate-y-12 opacity-0': !isVisible}" class="relative transition-all duration-1000 delay-300 ease-out mt-12 lg:mt-0">
                        <!-- Dynamic Background Image Container -->
                        <div class="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white dark:border-gray-800 group transition-colors duration-300 h-[400px] lg:h-[500px] bg-gray-100 dark:bg-gray-800">
                            ...
                            <div class="absolute inset-0 transition-opacity duration-700 ease-in-out" :class="minisplit1On ? 'opacity-100' : 'opacity-0 pointer-events-none'">
                                ...
                                <div class="absolute inset-0 bg-blue-500/10 mix-blend-overlay"></div> <!-- Cold tint overlay -->
                            </div>
                            ...
                            <div class="absolute inset-0 transition-opacity duration-700 ease-in-out" :class="!minisplit1On ? 'opacity-100' : 'opacity-0 pointer-events-none'">
                                ...
                                <div class="absolute inset-0 bg-orange-500/10 mix-blend-overlay"></div> <!-- Hot tint overlay -->
                            </div>
                        ...
                        <div class="absolute -top-12 left-1/2 -translate-x-1/2 z-20 w-[280px] lg:w-[320px] perspective-2000 cursor-pointer select-none transition-transform duration-300 hover:-translate-y-1" @click="toggleMinisplit(1)">
                            <div class="relative group">
                                ...
                                <div class="relative bg-gradient-to-b from-white via-slate-50 to-slate-100 dark:from-slate-800 dark:via-slate-850 dark:to-slate-900 rounded-t-[3rem] rounded-b-2xl h-28 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.4)] border-x border-t border-white/80 dark:border-slate-700/50 overflow-hidden z-10 transition-all duration-300" :class="{ 'opacity-90 grayscale-[0.3]': !minisplit1On }">
                                    ...
                                    <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-2000"></div>

                                    <!-- Power Display (ON/OFF) -->
                                    <div class="absolute top-1/2 -translate-y-1/2 left-8 px-3 py-1.5 rounded-lg transition-all duration-300" :class="minisplit1On ? 'bg-green-500/10 border border-green-400/20' : 'bg-gray-500/10 border border-gray-400/20'">
                                        <span class="font-mono text-xs font-black tracking-wider transition-colors duration-300" :class="minisplit1On ? 'text-green-500 drop-shadow-[0_0_8px_rgba(34,197,94,0.6)]' : 'text-gray-400'">
                                            {{ minisplit1On ? 'ON' : 'OFF' }}
                                        </span>
                                    </div>
                                    ...
                                    <div class="absolute top-5 right-10 flex gap-1.5 items-center">
                                        <div class="w-2.5 h-2.5 rounded-full transition-all duration-300" :class="minisplit1On ? 'bg-green-500 shadow-[0_0_10px_rgba(34,197,94,0.9)] animate-pulse' : 'bg-gray-400 bg-opacity-30'"></div>
                                    </div>

                                    <!-- Temperature Display -->
                                    <div class="absolute bottom-6 right-10 font-mono text-xl font-bold select-none transition-colors duration-300" :class="minisplit1On ? 'text-blue-400/80 drop-shadow-[0_0_5px_rgba(96,165,250,0.5)]' : 'text-gray-300/20'">
                                        {{ minisplit1On ? '22°' : '--' }}
                                    </div>
                                ...
                                <div class="absolute -top-24 -right-12 z-30 w-48 animate-bounce-subtle pointer-events-none lg:pointer-events-auto">
                                    <div class="relative bg-white dark:bg-gray-800 p-4 rounded-2xl rounded-bl-none shadow-xl border border-gray-100 dark:border-gray-700">
                                        <div class="absolute -bottom-2 left-0 w-4 h-4 bg-white dark:bg-gray-800 border-b border-l border-gray-100 dark:border-gray-700 transform rotate-45"></div>
                                        ...
                                        <transition mode="out-in" enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0 translate-y-2" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition duration-200 ease-in" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 -translate-y-2">
                                            <div v-if="!minisplit1On" key="off-msg" class="text-center">
                                                <p class="text-xs font-bold text-gray-800 dark:text-gray-200 mb-1">Ambiente cálido</p>
                                                <p class="text-[10px] text-gray-500 leading-tight">Haz click en el equipo para refrescar el ambiente.</p>
                                            </div>
                                            <div v-else key="on-msg" class="text-center">
                                                <p class="text-xs font-bold text-[var(--color-primary)] mb-1">Confort optimizado</p>
                                                <p class="text-[10px] text-gray-500 leading-tight mb-2">¿Quieres este confort en tu hogar?</p>
                                                <Link :href="route('catalogo.index')" class="inline-block px-3 py-1 bg-[var(--color-primary)] text-white text-[10px] font-bold rounded-full hover:bg-orange-600 transition-colors pointer-events-auto">
                                                    Ver Equipos
                                                </Link>
                                            </div>
                                        </transition>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    >
                        <div class="relative aspect-[4/5] bg-white overflow-hidden">
                            <img :src="getImageUrl(item) || 'https://images.unsplash.com/photo-1585338107529-13afc5f02586?q=80&w=2070&auto=format&fit=crop'" @error="handleImageError" class="w-full h-full object-contain p-8 group-hover:scale-110 transition-transform duration-1000 ease-in-out" alt="Producto">
                            ...
                            <div class="absolute top-6 left-6 flex flex-col gap-2 z-10 transition-transform duration-500 group-hover:translate-x-1">
                                <span v-if="item.destacado" class="px-4 py-1.5 bg-[var(--color-primary)] animate-pulse rounded-full text-[10px] font-black uppercase tracking-[0.1em] text-white shadow-lg shadow-[var(--color-primary)]/30 border border-white/20">¡OFERTA!</span>
                                <span v-else class="px-4 py-1.5 bg-white/95 dark:bg-gray-800/90 backdrop-blur-xl rounded-full text-[10px] font-black uppercase tracking-[0.1em] text-[var(--color-primary)] dark:text-white shadow-sm border border-gray-100 dark:border-gray-700">Top Ventas</span>
        ...
        <section v-if="false" class="py-32 bg-white dark:bg-gray-900 relative overflow-hidden transition-colors duration-300">
                    ...
                    >
                        ...
                        <ul class="space-y-5 mb-12 flex-grow px-2">
                             <li v-for="beneficio in plan.beneficios_array" :key="beneficio" class="flex items-start gap-4 text-sm text-gray-600 dark:text-gray-300 font-medium group/item transition-colors">
                                <span class="w-6 h-6 rounded-full bg-[var(--color-primary-soft)] flex-shrink-0 flex items-center justify-center text-[var(--color-primary)] text-xs group-hover/item:bg-[var(--color-primary)] group-hover/item:text-white transition-all">
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center gap-5">
                                <span class="w-12 h-12 rounded-2xl bg-[var(--color-primary)] flex items-center justify-center text-lg text-white shadow-lg shadow-[var(--color-primary)]/30 group-hover:scale-110 transition-transform duration-300">
