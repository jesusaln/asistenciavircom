    ...
    <div class="w-full px-6 py-8">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white dark:text-gray-100">Editar Almacen: {{ form.nombre || 'Sin nombre' }}</h1>
            <p class="text-gray-600 dark:text-gray-300 dark:text-gray-300 mt-1">Modifica la información del almacen</p>
          </div>
          <button
            @click="cancel"
          ...
          <div class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <span class="ml-2 text-gray-900 dark:text-white dark:text-gray-100">{{ new Date(props.almacen.created_at).toLocaleDateString('es-MX') }}</span>
              </div>
              <div>
                <span class="text-gray-500 dark:text-gray-400 dark:text-gray-400">Última actualización:</span>
                <span class="ml-2 text-gray-900 dark:text-white dark:text-gray-100">{{ new Date(props.almacen.updated_at).toLocaleDateString('es-MX') }}</span>
              </div>
            </div>
          </div>
