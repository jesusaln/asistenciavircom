      ...
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border border-gray-100">
        ...
        <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50 flex justify-between items-center">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h2 class="text-xl font-bold text-gray-800">Nueva Entrada de Blog</h2>
              <p class="text-xs text-gray-600">Redacta o genera contenido para tu audiencia</p>
            </div>
          </div>
        ...
        <form @submit.prevent="submit" class="p-8 space-y-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2 p-4 bg-blue-50 rounded-lg border border-blue-100 flex items-start gap-3">
                <FontAwesomeIcon icon="info-circle" class="text-blue-500 mt-1" />
