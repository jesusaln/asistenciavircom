      ...
      <div class="bg-white dark:bg-slate-900 dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg border border-gray-100 dark:border-gray-700">
        ...
        <div class="p-6 border-b border-gray-200 dark:border-slate-800 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 flex justify-between items-center">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 dark:text-gray-100">Blog Corporativo</h2>
              <p class="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300">Administra tus artículos y noticias</p>
            </div>
          </div>
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-left">
            <thead class="bg-white dark:bg-slate-900 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700">
              <tr>
                <th class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-300 dark:text-gray-300 uppercase">Artículo</th>
                <th class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-300 dark:text-gray-300 uppercase">Categoría</th>
                <th class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-300 dark:text-gray-300 uppercase">Estado</th>
                <th class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-300 dark:text-gray-300 uppercase">Fecha</th>
                <th class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-300 dark:text-gray-300 uppercase">Visitas</th>
                <th class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-300 dark:text-gray-300 uppercase">Acciones</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700 text-sm">
              <tr v-for="post in posts" :key="post.id" class="hover:bg-white dark:bg-slate-900 dark:hover:bg-gray-700 transition-colors">
                <td class="px-6 py-4">
                  <div class="flex items-center gap-3">
                    ...
                    <div v-else class="w-10 h-10 rounded bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 dark:text-gray-400">
                        <FontAwesomeIcon icon="image" />
                    </div>
                    <div>
                      <div class="font-semibold text-gray-900 dark:text-white dark:text-gray-100">{{ post.titulo }}</div>
                      <div class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 truncate w-48">{{ post.resumen }}</div>
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4">
                ...
                <td class="px-6 py-4 font-medium">
                  <div class="flex items-center gap-1 text-gray-600 dark:text-gray-300 dark:text-gray-300">
                    <FontAwesomeIcon icon="eye" class="text-gray-400 dark:text-gray-500 dark:text-gray-400" />
                    {{ post.visitas }}
                  </div>
                </td>
                <td class="px-6 py-4">
              ...
              <tr v-if="posts.length === 0">
                <td colspan="6" class="px-6 py-20 text-center">
                  <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400 font-medium">No hay artículos creados aún</p>
