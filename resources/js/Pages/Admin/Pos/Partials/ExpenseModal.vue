        ...
        <div class="bg-slate-900 w-full max-w-md rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div class="p-6 border-b border-white/5 bg-gradient-to-r from-purple-600/10 to-transparent flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-black text-white uppercase tracking-tight">Otros Movimientos</h3>
                        <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Gastos o Entradas Diversas</p>
                    </div>
                </div>
            ...
            <div class="p-8 space-y-6 text-left">
                ...
                <div class="flex gap-2 p-1 bg-slate-800 rounded-2xl border border-white/5">
                    <button 
                        ...
                        :class="form.tipo === 'egreso' ? 'bg-rose-500 text-white shadow-lg' : 'text-slate-400 hover:text-white'"
                    ...
                    <button 
                        ...
                        :class="form.tipo === 'ingreso' ? 'bg-emerald-500 text-white shadow-lg' : 'text-slate-400 hover:text-white'"
                        class="flex-1 py-3 px-4 rounded-xl text-xs font-black uppercase tracking-widest transition-all"
                    >
                        Ingreso (+)
                    </button>
                ...
                <div class="space-y-2 text-left">
                    ...
                    <div class="relative group">
                        <span class="absolute left-6 top-1/2 -translate-y-1/2 text-2xl font-black text-slate-600 transition-colors group-focus-within:text-purple-400">$</span>
                        <input 
                            v-model="form.monto"
                            type="number" 
                            step="0.01"
                            placeholder="0.00"
                            class="w-full bg-slate-800/50 border-2 border-slate-700/50 rounded-3xl py-6 pl-12 pr-6 text-4xl font-black text-white focus:border-purple-500 focus:bg-slate-800 outline-none transition-all placeholder:text-slate-700"
                            ref="inputMonto"
                        >
                    </div>
                </div>
                ...
                <div class="space-y-2 text-left">
                    ...
                    <input 
                        ...
                        class="w-full bg-slate-800/50 border-2 border-slate-700/50 rounded-2xl py-4 px-6 text-white focus:border-purple-500 outline-none transition-all placeholder:text-slate-700 font-bold"
                    >
                </div>
                ...
                <div class="space-y-2 text-left">
                    ...
                    <input 
                        ...
                        class="w-full bg-slate-800/50 border-2 border-slate-700/50 rounded-2xl py-3 px-6 text-sm text-white focus:border-purple-500 outline-none transition-all placeholder:text-slate-700 font-bold"
                    >
                </div>
            </div>
            ...
            <div class="p-6 bg-slate-950/30 border-t border-white/5 flex gap-4">
                ...
                >
                    ...
                    <kbd class="px-2 py-0.5 rounded bg-white/10 text-[9px]">CTRL + ENTER</kbd>
                </button>
            </div>
        </div>
    </div>
