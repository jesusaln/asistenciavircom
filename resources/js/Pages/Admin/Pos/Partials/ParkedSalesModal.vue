            ...
            <div class="p-8 border-b border-white/5 bg-slate-900/50 flex items-center justify-between">
                <div>
                    <h3 class="text-2xl font-black text-white flex items-center gap-3">
                        <span class="w-10 h-10 rounded-xl bg-orange-500/20 text-orange-400 flex items-center justify-center">
                    ...
                    <div v-for="(sale, index) in parkedSales" :key="sale.id" 
                        ...
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="text-[10px] font-black bg-slate-900/50 px-2 py-0.5 rounded text-slate-400">
                        ...
                        <div class="flex gap-3 mt-2">
                             <button @click="emit('delete', index)" 
                                class="w-10 h-10 rounded-xl bg-slate-900 border border-white/5 flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-500/10 transition-colors"
                            ...
                            <button @click="emit('restore', index)" 
                                class="flex-1 bg-white text-slate-900 hover:bg-purple-100 font-black py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-white/5"
                            >
