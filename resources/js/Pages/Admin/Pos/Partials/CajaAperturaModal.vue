                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input 
                            :value="montoApertura"
                            type="number"
                            class="w-full bg-slate-950 border border-slate-700 rounded-xl px-4 py-3 text-white font-mono text-lg focus:border-brand-500 focus:ring-brand-500/20"
                            placeholder="0.00"
                            autofocus
                            @input="onMontoInput"
                        />
                    ...
                    <button 
                        @click="emit('open')"
                        :disabled="loading"
                        class="w-full bg-purple-600 hover:bg-purple-500 text-white font-bold py-3 rounded-xl disabled:opacity-50 transition-all shadow-xl shadow-purple-600/20"
                    >
