      ...
      <form @submit.prevent="submit" class="bg-white rounded-2xl shadow-lg border border-gray-200">
        <div class="p-8">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label for="asignado_id" class="block text-sm font-semibold text-gray-700 mb-2">
                Asignar a
              ...
              <div class="relative">
                <select
                  ...
                  class="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 appearance-none"
              ...
              <p v-if="form.errors.asignado_id" class="mt-2 text-sm text-red-600">{{ form.errors.asignado_id }}</p>
