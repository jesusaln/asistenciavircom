<template>
    <div>
        <div class="mb-6">
            <h3 class="text-lg font-medium text-slate-900 mb-4">Reporte de Préstamos</h3>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-xl">
                    <div class="text-2xl font-bold text-emerald-600">{{ prestamosActivos }}</div>
                    <div class="text-sm text-emerald-600">Préstamos Activos</div>
                </div>
        ...
        <div class="py-8 text-center">
            ...
            <h3 class="text-lg font-medium text-slate-900 mb-2">Préstamos por Cliente</h3>
            <p class="text-sm text-slate-500 mb-4">Análisis detallado de préstamos agrupados por cliente</p>
            <div class="bg-white p-6 rounded-xl w-full">
                <div class="text-center">
                    <p class="text-slate-500">Los datos de préstamos se cargan desde el controlador específico</p>
                    <Link
                        :href="route('reportes.prestamos-por-cliente')"
                        class="inline-flex items-center mt-4 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-colors"
                    >
