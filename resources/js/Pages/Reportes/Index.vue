                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg min-h-[600px]">
                    <div class="p-6">
                        ...
                        <div v-show="activeTab === 'citas'">
                            ...
                            <div class="overflow-x-auto border border-gray-200 rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-white"><tr><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Fecha</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Folio</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Cliente</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Técnico</th><th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Estado</th></tr></thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="cita in reportesCitas" :key="cita.id">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ formatDateTime(cita.fecha_hora) }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-800">{{ cita.folio || '—' }}</td>
