...
<template>
    ...
    <div class="min-h-screen bg-white dark:bg-slate-950 dark:text-slate-100 flex flex-col font-sans" :style="cssVars">
        ...
        <main class="flex-grow py-8 px-4">
            <div class="w-full grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-slate-900/70 rounded-3xl shadow-sm border border-gray-100 dark:border-slate-800 p-6 md:p-10 transition-all hover:shadow-md">
                        <h2 class="text-2xl font-black text-gray-900 dark:text-slate-100 mb-8 flex items-center gap-3">
                                    ...
                                    <div v-if="form.requiere_factura" class="grid grid-cols-1 md:grid-cols-2 gap-6 p-8 bg-white/50 rounded-[2.5rem] border border-gray-100 shadow-inner">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                v-model="form.rfc"
                                                type="text"
                                                class="form-input-premium bg-white dark:bg-slate-900/40 dark:text-slate-100 shadow-sm border-gray-100 dark:border-slate-700 uppercase"
                                        ...
                                        <div>
                                            ...
                                            <input v-model="form.domicilio_fiscal_cp" type="text" class="form-input-premium bg-white dark:bg-slate-900/40 dark:text-slate-100 shadow-sm border-gray-100 dark:border-slate-700" placeholder="12345" maxlength="5" inputmode="numeric" @input="form.domicilio_fiscal_cp = onlyDigits(form.domicilio_fiscal_cp, 5)">
