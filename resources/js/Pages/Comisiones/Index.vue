                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-white">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-semibold text-gray-500 uppercase">Pendiente</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                         <tr v-if="vendedoresFiltrados.length === 0">
                            <td colspan="8" class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-500">No hay comisiones para este filtro</p>
                            </td>
                        </tr>
                        <tr v-for="vendedor in vendedoresFiltrados" :key="`${vendedor.type}-${vendedor.id}`" class="hover:bg-amber-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <span class="text-lg font-bold text-green-600">${{ formatMonto(vendedor.comision_bruto || vendedor.comision) }}</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <span class="text-lg font-bold" :class="vendedor.pendiente > 0 ? 'text-amber-600' : 'text-gray-400'">${{ formatMonto(vendedor.pendiente) }}</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
