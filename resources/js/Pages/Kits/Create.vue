      ...
      <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
          <div class="flex justify-between items-center">
            <div>
              <h1 class="text-3xl font-bold text-gray-900">Crear Nuevo Kit</h1>
              <p class="mt-2 text-sm text-gray-600">Define un kit con productos y/o servicios</p>
            </div>
        ...
        <form @submit.prevent="submitForm" class="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div class="px-6 py-4 bg-white border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-600">Define el nombre, precio y detalles básicos del kit</p>
          </div>
          ...
          <div class="px-6 py-4 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center">
              <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Agrega productos y/o servicios que conforman este kit</p>
              </div>
