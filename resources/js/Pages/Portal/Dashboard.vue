                ...
                <div class="lg:col-span-3">
                    ...
                    <div v-show="activeTab === 'resumen'" class="animate-fade-in space-y-8">
                        <div class="grid sm:grid-cols-2 gap-6">
                            <!-- Widget: Soporte -->
                            <div class="bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 rounded-[2rem] p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 relative overflow-hidden group transition-colors">
                                ...
                                <div class="relative z-10">
                                    <div class="flex items-center gap-4 mb-6">
                                        ...
                                        <h3 class="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tight transition-colors">Soporte Técnico</h3>
                                    </div>
                                    <div class="flex items-end justify-between">
                                        <div>
                                            <p class="text-4xl font-black text-gray-900 dark:text-white transition-colors">{{ tickets.total || 0 }}</p>
                                            <p class="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Tickets Totales</p>
                                        </div>
                            ...
                            <div class="bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 rounded-[2rem] p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 relative overflow-hidden group transition-colors">
                                ...
                                <div class="relative z-10">
                                    <div class="flex items-center gap-4 mb-6">
                                        ...
                                        <h3 class="text-lg font-black text-gray-900 dark:text-white uppercase tracking-tight transition-colors">Finanzas</h3>
                                    </div>
                                    <div class="flex items-end justify-between">
                                        <div>
                                            ...
                                            <p class="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Por Pagar</p>
                                        </div>
                                    ...
                                    <div class="grid sm:grid-cols-3 gap-4 mb-6">
                                        ...
                                        <div class="p-5 bg-white/5 dark:bg-gray-700/20 rounded-2xl border border-white/10 dark:border-gray-700/50 transition-colors">
                                            ...
                                            <div class="flex items-baseline gap-2">
                                                ...
                                                <span class="text-sm text-gray-400 dark:text-gray-500">de {{ polizas[0]?.limite_mensual_tickets || '∞' }}</span>
                                            </div>
                                            ...
                                            <p class="text-[9px] text-gray-500 dark:text-gray-400 mt-2">{{ polizas[0]?.limite_mensual_tickets ? polizas[0].limite_mensual_tickets - (polizas[0]?.tickets_mes_actual_count || 0) : '∞' }} disponibles</p>
                                        </div>
                                        
                                        <!-- Horas Widget -->
                                        <div class="p-5 bg-white/5 dark:bg-gray-700/20 rounded-2xl border border-white/10 dark:border-gray-700/50 transition-colors">
                                            <p class="text-[9px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-2">⏱️ Horas de Soporte</p>
                                            <div class="flex items-baseline gap-2">
                                                <span class="text-3xl font-black text-white">{{ Math.round(polizas[0]?.horas_consumidas_mes || 0) }}</span>
                                                <span class="text-sm text-gray-400 dark:text-gray-500">de {{ polizas[0]?.horas_incluidas_mensual || 0 }} hrs</span>
                                            </div>
                                            <div class="mt-3 w-full bg-white/10 dark:bg-white/5 rounded-full h-1.5">
                                            ...
                                            <p class="text-[9px] text-gray-500 dark:text-gray-400 mt-2">{{ polizas[0]?.horas_incluidas_mensual ? (polizas[0].horas_incluidas_mensual - (polizas[0]?.horas_consumidas_mes || 0)).toFixed(1) : 0 }} hrs disponibles</p>
                                        </div>
                                        
                                        <!-- Visitas Widget -->
                                        <div class="p-5 bg-white/5 dark:bg-gray-700/20 rounded-2xl border border-white/10 dark:border-gray-700/50 transition-colors">
                                            <p class="text-[9px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-2">🚗 Visitas en Sitio</p>
                                            <div class="flex items-baseline gap-2">
                                                <span class="text-3xl font-black text-white">{{ polizas[0]?.visitas_sitio_consumidas_mes || 0 }}</span>
                                                <span class="text-sm text-gray-400 dark:text-gray-500">de {{ polizas[0]?.visitas_sitio_mensuales || 0 }}</span>
                                            </div>
                                            <div class="mt-3 w-full bg-white/10 dark:bg-white/5 rounded-full h-1.5">
                                            ...
                                            <p class="text-[9px] text-gray-500 dark:text-gray-400 mt-2">{{ polizas[0]?.visitas_sitio_mensuales ? polizas[0].visitas_sitio_mensuales - (polizas[0]?.visitas_sitio_consumidas_mes || 0) : 0 }} disponibles</p>
                                        </div>
                                    </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors">
                            <div class="divide-y divide-gray-50 dark:divide-gray-700">
                                <div v-for="ticket in tickets.data" :key="ticket.id" class="group">
                                    <Link :href="route('portal.tickets.show', ticket)" class="block p-6 hover:bg-white/50 dark:hover:bg-gray-750 transition-all">
                                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                            <div class="flex gap-4 items-start">
                                                <div class="mt-1 w-10 h-10 rounded-xl bg-white dark:bg-gray-700 flex items-center justify-center text-gray-400 group-hover:bg-[var(--color-primary-soft)] group-hover:text-[var(--color-primary)] transition-all">
                                                    <font-awesome-icon icon="ticket-alt" />
                                                </div>
                                                <div>
                                                    <h3 class="font-bold text-gray-900 dark:text-gray-100 group-hover:text-[var(--color-primary)] transition-colors">{{ ticket.titulo }}</h3>
                                                    <div class="flex items-center gap-3 mt-1">
                                                        <span class="text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 font-mono transition-colors">{{ ticket.numero }}</span>
                                                        <span class="h-1 w-1 rounded-full bg-gray-300 dark:bg-gray-600"></span>
                                                        <span class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">{{ ticket.categoria?.nombre || 'General' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex items-center justify-between sm:justify-end gap-6">
                                                <div class="text-right hidden sm:block">
                                                    <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Fecha</p>
                                                    <p class="text-xs font-bold text-gray-600 dark:text-gray-400 transition-colors">{{ formatDate(ticket.created_at) }}</p>
                                                </div>
                                                <span 
                                ...
                                <div v-if="tickets.data.length === 0" class="p-20 text-center">
                                    <div class="w-20 h-20 bg-white dark:bg-gray-750 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl shadow-sm">
                                        ✨
                                    </div>
                                    <h3 class="text-lg font-black text-gray-900 dark:text-white mb-2 transition-colors">Todo en Orden</h3>
                                    <p class="text-gray-500 dark:text-gray-400 font-medium transition-colors">No tiene solicitudes de soporte activas en este momento.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-show="activeTab === 'polizas'" class="animate-fade-in space-y-6">
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            <div v-for="poliza in polizas" :key="poliza.id" class="bg-white dark:bg-gray-800 rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 overflow-hidden group hover:-translate-y-1 transition-all duration-300">
                                <div class="p-8">
                                    <div class="flex justify-between items-start mb-6">
                                    ...
                                    <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mb-6 font-mono transition-colors">{{ poliza.folio }}</p>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-50 dark:border-gray-750 transition-colors">
                                        ...
                                        <div v-if="poliza.horas_incluidas_mensual > 0">
                                            <div class="flex justify-between items-end mb-2">
                                                <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Horas de Soporte</p>
                                                <p class="text-[10px] font-bold transition-colors" :class="poliza.excede_horas ? 'text-red-500 dark:text-red-400' : 'text-gray-600 dark:text-gray-400'">
                                                    {{ poliza.horas_consumidas_mes || 0 }} / {{ poliza.horas_incluidas_mensual }} hrs
                                                </p>
                                            </div>
                                            <div class="w-full bg-gray-50 dark:bg-gray-900 rounded-full h-1.5 overflow-hidden transition-colors">
                                                 <div 
                                        ...
                                        <div v-if="poliza.limite_mensual_tickets > 0">
                                            <div class="flex justify-between items-end mb-2">
                                                <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Tickets Incluidos</p>
                                                <p class="text-[10px] font-bold text-gray-600 dark:text-gray-400 transition-colors">
                                    ...
                                    <div class="mt-4 flex items-center justify-between">
                                        <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">
                                            Vencimiento: <span class="text-gray-900 dark:text-white ml-1 transition-colors">{{ poliza.fecha_fin ? formatDate(poliza.fecha_fin) : 'Mensual' }}</span>
                                        </p>
                                ...
                                <div class="bg-gray-50 dark:bg-gray-800/50 px-8 py-4 flex justify-between items-center group-hover:bg-[var(--color-primary-soft)] dark:group-hover:bg-blue-900/20 transition-colors">
                                    <span class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest group-hover:text-[var(--color-primary)] dark:group-hover:text-blue-400 transition-colors">
                                        {{ poliza.renovacion_automatica ? 'Renovación Automática' : 'Renovación Manual' }}
                                    </span>
                                    <div class="flex gap-2">
                                        <a :href="route('portal.polizas.imprimir', poliza.id)" target="_blank" class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500 hover:text-[var(--color-primary)] dark:hover:text-blue-400 hover:underline flex items-center gap-1 transition-colors">
                            ...
                            <div v-if="polizas.length === 0" class="col-span-full py-20 text-center bg-white dark:bg-gray-800 rounded-[2rem] border-2 border-dashed border-gray-100 dark:border-gray-700 transition-colors">
                                <p class="text-gray-400 dark:text-gray-500 font-bold mb-6 transition-colors">No tiene pólizas vigentes en su cuenta.</p>
                    ...
                    <div v-show="activeTab === 'citas'" class="animate-fade-in space-y-6">
                        <div class="px-2">
                            <h2 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight transition-colors">Mis Próximas Citas</h2>
                        </div>
                        <div v-if="citas && citas.length > 0" class="grid gap-6 md:grid-cols-2">
                            <div v-for="cita in citas" :key="cita.id" class="bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 p-8 transition-colors">
                                ...
                                <p class="text-lg font-black text-gray-900 dark:text-white transition-colors">{{ formatDate(cita.fecha_hora) }}</p>
                                <p class="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Técnico: {{ cita.tecnico?.name || 'Por confirmar' }}</p>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-4 h-10 overflow-hidden transition-colors">{{ cita.descripcion }}</p>
                            </div>
                        </div>
                        <div v-else class="py-20 text-center bg-white dark:bg-gray-800/50 rounded-[2rem] border-2 border-dashed border-gray-100 dark:border-gray-700 transition-colors">
                            <p class="text-gray-400 dark:text-gray-500 font-bold">No tiene citas programadas.</p>
                        </div>
                    </div>

                    <div v-show="activeTab === 'equipos'" class="animate-fade-in space-y-6">
                        <div class="px-2">
                             <h2 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight transition-colors">Inventario de Equipos Protegidos</h2>
                             <p class="text-gray-500 dark:text-gray-400 text-sm font-medium transition-colors">Equipos registrados bajo sus contratos de soporte.</p>
                        </div>

                        <div class="grid gap-6 md:grid-cols-2">
                            <template v-for="poliza in polizas" :key="'e-'+poliza.id">
                                <div v-for="equipo in poliza.equipos" :key="equipo.id" 
                                     class="bg-white dark:bg-gray-800 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 rounded-[2rem] p-6 flex items-center gap-6 group hover:border-[var(--color-primary)] dark:hover:border-[var(--color-primary)] transition-all">
                                    <div class="w-14 h-14 bg-white dark:bg-gray-900 rounded-2xl flex items-center justify-center text-gray-400 dark:text-gray-500 group-hover:bg-[var(--color-primary-soft)] dark:group-hover:bg-orange-500/10 group-hover:text-[var(--color-primary)] transition-all text-xl shadow-inner">
                                        <font-awesome-icon :icon="equipo.tipo === 'Laptop' || equipo.tipo === 'Servidor' ? 'server' : 'desktop'" />
                                    </div>
                                    <div class="flex-1">
                                        <h4 class="font-bold text-gray-900 dark:text-white transition-colors">{{ equipo.nombre || equipo.modelo }}</h4>
                                        <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest font-mono transition-colors">S/N: {{ equipo.numero_serie || 'N/A' }}</p>
                            ...
                            <template v-for="poliza in polizas" :key="'ce-'+poliza.id">
                                <div v-for="(equipo, idx) in poliza.condiciones_especiales?.equipos_cliente" :key="poliza.id + '-ce-' + idx"
                                    ...
                                    <div class="flex-1">
                                        <h4 class="font-bold text-gray-900 dark:text-white transition-colors">{{ equipo.nombre }}</h4>
                                        <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest font-mono transition-colors">S/N: {{ equipo.serie || 'N/A' }}</p>
                                        <div class="flex items-center gap-2 mt-2">
                            ...
                            <div v-if="!polizas.some(p => p.equipos?.length > 0 || p.condiciones_especiales?.equipos_cliente?.length > 0)" 
                                 class="col-span-full py-20 bg-white dark:bg-gray-800/30 rounded-[2rem] border-2 border-dashed border-gray-100 dark:border-gray-700 text-center transition-colors">
                                <div class="w-16 h-16 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4 text-gray-300 dark:text-gray-600 transition-colors">
                                    <font-awesome-icon icon="desktop" size="lg" />
                                </div>
                                <h3 class="text-lg font-black text-gray-900 dark:text-white mb-1 transition-colors">Sin equipos vinculados</h3>
                                <p class="text-gray-500 dark:text-gray-400 font-medium text-sm transition-colors">Comuníquese con soporte para registrar sus activos.</p>
                            </div>
                        </div>
                        ...
                        <div v-if="rentas && rentas.length > 0" class="mt-12">
                            <div class="px-2 mb-6">
                                 <h2 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight transition-colors">Equipos en Renta (POS)</h2>
                                 <p class="text-gray-500 dark:text-gray-400 text-sm font-medium transition-colors">Equipos activos actualmente bajo contrato de arrendamiento.</p>
                            </div>
                            
                            <div class="grid gap-6 md:grid-cols-2">
                                <template v-for="renta in rentas" :key="'r-'+renta.id">
                                    <div v-for="equipo in renta.equipos" :key="'re-'+equipo.id" 
                                         class="bg-white dark:bg-gray-800 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 rounded-[2rem] p-6 flex items-center gap-6 group hover:border-emerald-500 dark:hover:border-emerald-500 transition-all relative overflow-hidden">
                                        ...
                                        <div class="w-14 h-14 bg-white dark:bg-gray-900 rounded-2xl flex items-center justify-center text-gray-400 dark:text-gray-500 group-hover:bg-emerald-50 dark:group-hover:bg-emerald-500/10 group-hover:text-emerald-600 transition-all text-xl shadow-inner">
                                            <font-awesome-icon :icon="equipo.tipo === 'Laptop' || equipo.tipo === 'Servidor' ? 'server' : 'desktop'" />
                                        </div>
                                        <div class="flex-1">
                                            <h4 class="font-bold text-gray-900 dark:text-white transition-colors">{{ equipo.nombre || equipo.modelo }}</h4>
                    ...
                    <div v-show="activeTab === 'pagos'" class="animate-fade-in space-y-6" id="historial-pagos">
                        ...
                        <div v-if="pagosPendientes && pagosPendientes.length > 0" class="mb-8">
                            <div class="px-2 mb-4">
                                <h2 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight flex items-center gap-3 transition-colors">
                                    <span class="w-3 h-3 bg-red-500 rounded-full animate-pulse"></span>
                                    Pagos Pendientes ({{ pagosPendientes.length }})
                                </h2>
                                <p class="text-gray-500 dark:text-gray-400 text-sm font-medium transition-colors">Estos son los pagos que requieren su atención.</p>
                            </div>

                            <div class="bg-white dark:bg-gray-800 rounded-[2rem] shadow-xl shadow-red-500/10 dark:shadow-none border border-red-100 dark:border-red-900/30 overflow-hidden transition-colors">
                                    ...
                                    <table class="w-full text-left">
                                        ...
                                        <tbody class="divide-y divide-red-50 dark:divide-red-900/20">
                                            <tr v-for="pago in pagosPendientes" :key="pago.tipo + '-' + pago.id" class="hover:bg-red-50/50 dark:hover:bg-red-900/10 transition-colors">
                                                ...
                                                <td class="px-8 py-4 font-mono text-xs font-bold text-gray-500 dark:text-gray-400 transition-colors">#{{ pago.folio }}</td>
                                                <td class="px-8 py-4 text-xs font-medium text-gray-600 dark:text-gray-400 max-w-xs truncate transition-colors">{{ pago.concepto }}</td>
                                                <td class="px-8 py-4 text-xs font-bold transition-colors" :class="isOverdue(pago.fecha_vencimiento) ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-white'">
                        ...
                        <div class="px-2">
                             <h2 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight transition-colors">Historial de Ventas</h2>
                        </div>

                        <div class="bg-white dark:bg-gray-800 rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 overflow-hidden transition-colors">
                            <div class="overflow-x-auto">
                                <table class="w-full text-left">
                                    <thead class="bg-white dark:bg-gray-900/40 border-b border-gray-100 dark:border-gray-700/50">
                                        <tr>
                                            <th class="px-8 py-4 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Folio</th>
                                            <th class="px-8 py-4 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Fecha</th>
                                            <th class="px-8 py-4 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Concepto</th>
                                            <th class="px-8 py-4 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest text-right">Monto</th>
                                            <th class="px-8 py-4 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest text-center">Estado</th>
                                            <th class="px-8 py-4 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest text-right">Acciones</th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-gray-50 dark:divide-gray-700/50">
                                        <tr v-for="venta in ventas.data" :key="venta.id" class="hover:bg-white/50 dark:hover:bg-gray-700/20 transition-colors">
                                            <td class="px-8 py-4 font-mono text-xs font-bold text-gray-500 dark:text-gray-400 transition-colors">#{{ venta.folio || venta.id }}</td>
                                            <td class="px-8 py-4 text-xs font-bold text-gray-900 dark:text-white transition-colors">{{ formatDate(venta.fecha) }}</td>
                                            <td class="px-8 py-4 text-xs font-medium text-gray-600 dark:text-gray-400 max-w-xs truncate transition-colors">{{ venta.notas || 'Venta General' }}</td>
                                            <td class="px-8 py-4 text-xs font-black text-gray-900 dark:text-white text-right transition-colors">${{ Number(venta.total).toLocaleString('es-MX', {minimumFractionDigits: 2}) }}</td>
                                            ...
                                            <td class="px-8 py-4 text-right">
                                                <a :href="route('portal.ventas.pdf', venta.id)" 
                                                   target="_blank"
                                                   class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-gray-200 dark:hover:bg-gray-600 transition-all inline-flex items-center gap-1 shadow-sm"
                                                   title="Descargar PDF">
                                        ...
                                        <tr v-if="!ventas.data || ventas.data.length === 0">
                                            <td colspan="6" class="px-8 py-12 text-center text-gray-400 dark:text-gray-500 text-sm font-medium transition-colors">No se encontraron registros de ventas.</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                         ...
                         <div v-if="ventas.links && ventas.links.length > 3" class="flex justify-center gap-2 mt-4">
                            <template v-for="(link, key) in ventas.links" :key="key">
                                <Link 
                                    ...
                                    :class="link.active ? 'bg-[var(--color-primary)] text-white border-[var(--color-primary)] shadow-lg shadow-orange-500/20' : 'bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700'"
                                    v-html="link.label"
                                />
                                <span v-else class="px-4 py-2 text-xs text-gray-400 dark:text-gray-600 transition-colors" v-html="link.label"></span>
                            </template>
                        </div>
                    </div>
                    ...
                    <div v-show="activeTab === 'credenciales'" class="animate-fade-in space-y-6">
                        <div class="px-2">
                             <h2 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight transition-colors">Caja Fuerte de Accesos</h2>
                             <p class="text-gray-500 dark:text-gray-400 text-sm font-medium transition-colors">Sus claves de acceso se encuentran encriptadas y cada revelación es auditada.</p>
                        </div>

                        <div class="grid gap-6">
                            <div v-for="cred in credenciales" :key="cred.id" 
                                 class="bg-white dark:bg-gray-800 rounded-[2rem] p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 border-l-4 border-l-[var(--color-primary)] transition-colors">
                                <div class="flex flex-col md:flex-row justify-between gap-6">
                                    <div class="flex-1 space-y-4">
                                        <div>
                                            <h3 class="text-xl font-black text-gray-900 dark:text-white transition-colors">{{ cred.nombre }}</h3>
                                            <p v-if="cred.host" class="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">{{ cred.host }}{{ cred.puerto ? ':' + cred.puerto : '' }}</p>
                                        </div>
                                        
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl transition-colors">
                                                <p class="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1 transition-colors">Usuario</p>
                                                <p class="text-sm font-bold text-gray-800 dark:text-gray-200 transition-colors">{{ cred.usuario }}</p>
                                            </div>
                                            <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl relative overflow-hidden transition-colors">
                                                <p class="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1 transition-colors">Contraseña</p>
                                                <div class="flex items-center justify-between gap-2">
                                                    <p class="text-sm font-mono font-bold text-gray-800 dark:text-gray-200 transition-colors">
                                                        {{ revealedPasswords[cred.id] || '••••••••••••' }}
                                                    </p>
                                                    <button 
                                                        @click="revealPassword(cred.id)"
                                                        class="p-1 hover:text-[var(--color-primary)] transition-colors text-gray-400 dark:text-gray-500"
                                        ...
                                        <div v-if="cred.notas" class="border-t border-gray-100 dark:border-gray-700/50 pt-4 mt-4 transition-colors">
                                            <p class="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1 transition-colors">Notas Adicionales</p>
                                            <p class="text-xs text-gray-600 dark:text-gray-400 font-medium transition-colors">{{ cred.notas }}</p>
                                        </div>
                                    </div>
                            ...
                            <div v-if="credenciales.length === 0" class="py-20 bg-white dark:bg-gray-800/30 rounded-[2rem] border-2 border-dashed border-gray-100 dark:border-gray-700 text-center transition-colors">
                                <div class="w-16 h-16 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4 text-gray-300 dark:text-gray-600 transition-colors">
                                    <font-awesome-icon icon="lock" size="lg" />
                                </div>
                                <h3 class="text-lg font-black text-gray-900 dark:text-white mb-1 transition-colors">No hay credenciales</h3>
                                <p class="text-gray-500 dark:text-gray-400 font-medium text-sm transition-colors">Nuestro equipo aún no ha registrado claves de acceso para su cuenta.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-show="activeTab === 'pedidos'" class="animate-fade-in space-y-6">
                        <div class="px-2">
                             <h2 class="text-xl font-black text-gray-900 dark:text-white uppercase tracking-tight transition-colors">Mis Pedidos Online</h2>
                             <p class="text-gray-500 dark:text-gray-400 text-sm font-medium transition-colors">Siga el estado de sus compras realizadas en nuestra tienda.</p>
                        </div>

                        <div class="grid gap-6">
                            <div v-for="pedido in pedidos" :key="pedido.id" 
                                 class="bg-white dark:bg-gray-800 rounded-[2rem] p-8 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 group hover:border-[var(--color-primary)] dark:hover:border-[var(--color-primary)] transition-all">
                                <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                                    <div class="flex items-center gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-bold text-gray-500 dark:text-gray-400 transition-colors">{{ formatDate(pedido.fecha_pedido || pedido.created_at) }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-col items-end gap-2">
                                        ...
                                        <p class="text-lg font-black text-gray-900 dark:text-white transition-colors">${{ Number(pedido.total).toLocaleString('es-MX', {minimumFractionDigits: 2}) }}</p>
                                    </div>
                                    
                                    <div class="flex gap-4">
                                         <Link :href="route('portal.pedidos.show', pedido.id)" class="px-6 py-3 bg-white dark:bg-gray-700 text-gray-700 dark:text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-gray-100 dark:hover:bg-gray-600 transition-all border border-gray-200 dark:border-gray-600 shadow-sm">
                                            Detalles
                                        </Link>
                                    </div>
                                </div>
                                ...
                                <div v-if="pedido.numero_guia" class="mt-6 pt-6 border-t border-gray-50 dark:border-gray-700 flex items-center gap-4 text-emerald-600 dark:text-emerald-400 transition-colors">
                                    ...
                                    <p class="text-xs font-bold uppercase tracking-widest">Guía: <span class="text-gray-900 dark:text-white ml-2 font-mono">{{ pedido.numero_guia }}</span> ({{ pedido.empresa_envio }})</p>
                                </div>
                            </div>

                            <div v-if="pedidos.length === 0" class="py-20 bg-white dark:bg-gray-800/30 rounded-[2rem] border-2 border-dashed border-gray-100 dark:border-gray-700 text-center transition-colors">
                                <div class="w-16 h-16 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4 text-gray-300 dark:text-gray-600 transition-colors">
                                    <font-awesome-icon icon="shopping-cart" size="lg" />
                                </div>
                                <h3 class="text-lg font-black text-gray-900 dark:text-white mb-1 transition-colors">No hay pedidos</h3>
                                <p class="text-gray-500 dark:text-gray-400 font-medium text-sm transition-colors">Aún no ha realizado compras en nuestra tienda en línea.</p>
                    ...
                    <div v-show="activeTab === 'ayuda'" class="animate-fade-in space-y-10">
                        <div class="px-2">
                             <h2 class="text-3xl font-black text-gray-900 dark:text-white tracking-tight transition-colors">Centro de Ayuda</h2>
                             <p class="text-gray-500 dark:text-gray-400 font-medium mt-2 transition-colors">Encuentre respuestas rápidas y recursos para sus servicios.</p>
                        </div>

                        <!-- Canales de Soporte Rápido -->
                        <div class="grid sm:grid-cols-3 gap-6">
                            <div class="bg-white dark:bg-gray-800 p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 text-center group hover:border-[var(--color-primary)] dark:hover:border-[var(--color-primary)] transition-all">
                                ...
                                <h4 class="font-black text-gray-900 dark:text-white mb-2 font-mono transition-colors">WhatsApp</h4>
                                <p class="text-xs text-gray-500 dark:text-gray-400 font-medium mb-4 transition-colors">Atención inmediata para urgencias.</p>
                            ...
                            <div class="bg-white dark:bg-gray-800 p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 text-center group hover:border-[var(--color-primary)] dark:hover:border-[var(--color-primary)] transition-all">
                                ...
                                <h4 class="font-black text-gray-900 dark:text-white mb-2 font-mono transition-colors">Email</h4>
                                <p class="text-xs text-gray-500 dark:text-gray-400 font-medium mb-4 transition-colors">Consultas generales y seguimientos.</p>
                                <a :href="'mailto:' + (empresa?.email || 'soporte@climasdeldesierto.com')" class="px-6 py-2 bg-blue-500 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/20">Enviar Correo</a>
                            </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700/50 text-center group hover:border-[var(--color-primary)] dark:hover:border-[var(--color-primary)] transition-all">
                                ...
                                <h4 class="font-black text-gray-900 dark:text-white mb-2 font-mono transition-colors">Manuales</h4>
                                <p class="text-xs text-gray-500 dark:text-gray-400 font-medium mb-4 transition-colors">Guías de configuración rápidas.</p>
                        ...
                        <!-- FAQ Section -->
                        <div class="bg-white dark:bg-gray-800 rounded-[3rem] p-10 shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-50 dark:border-gray-700/50 transition-colors">
                            <h3 class="text-2xl font-black text-gray-900 dark:text-white mb-10 text-center transition-colors">Preguntas Frecuentes</h3>
                            
                            <div class="space-y-4 w-full">
                                <div v-for="faq in faqs" :key="faq.id" 
                                     class="border border-gray-100 dark:border-gray-700/50 rounded-[2rem] overflow-hidden transition-all duration-300"
                                     :class="activeFaq === faq.id ? 'border-[var(--color-primary)] dark:border-[var(--color-primary)] shadow-lg' : 'hover:border-gray-200 dark:hover:border-gray-600'">
                                    
                                    <button 
                                        @click="toggleFaq(faq.id)"
                                        class="w-full px-8 py-6 flex items-center justify-between text-left group"
                                    >
                                        <span class="font-bold text-gray-900 dark:text-white group-hover:text-[var(--color-primary)] dark:group-hover:text-[var(--color-primary)] transition-colors">{{ faq.pregunta }}</span>
                                        <font-awesome-icon 
                                            :icon="activeFaq === faq.id ? 'minus' : 'plus'" 
                                            class="text-xs transition-transform duration-300"
                                            :class="activeFaq === faq.id ? 'text-[var(--color-primary)]' : 'text-gray-300 dark:text-gray-600'"
                                        />
                                    </button>

                                    <div v-show="activeFaq === faq.id" class="px-8 pb-8 animate-fade-in">
                                        <div class="h-px bg-white dark:bg-gray-700/50 mb-6"></div>
                                        <p class="text-gray-600 dark:text-gray-400 font-medium leading-relaxed whitespace-pre-line text-sm transition-colors">
                                            {{ faq.respuesta }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div v-if="faqs.length === 0" class="text-center py-10">
                                    <p class="text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest text-xs transition-colors">No hay preguntas frecuentes registradas.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-show="activeTab === 'perfil'" class="animate-fade-in space-y-10 pb-20">
                        <div class="px-2">
                             <h2 class="text-3xl font-black text-gray-900 dark:text-white tracking-tight transition-colors">Mi Perfil</h2>
                             <p class="text-gray-500 dark:text-gray-400 font-medium mt-2 transition-colors">Gestione sus datos de contacto, facturación y seguridad.</p>
                        </div>

                        <form @submit.prevent="updateProfile" class="space-y-8">
                            <!-- Sección: Datos de Contacto -->
                            <div class="bg-white dark:bg-gray-800 rounded-[3rem] p-10 shadow-xl border border-gray-100 dark:border-gray-700/50 transition-colors">
                                <h3 class="text-lg font-black text-gray-900 dark:text-white mb-8 flex items-center gap-3 transition-colors">
                                ...
                                <div class="grid sm:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Nombre o Razón Social</label>
                                        <input v-model="profileForm.nombre_razon_social" type="text" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Correo Electrónico</label>
                                        <input v-model="profileForm.email" type="email" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                    </div>
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Teléfono</label>
                                        <input v-model="profileForm.telefono" type="text" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                    </div>
                                </div>

                                <div class="mt-8 pt-8 border-t border-gray-50 dark:border-gray-700/50 transition-colors">
                                    <p class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-6 transition-colors">Dirección de Contacto</p>
                                    <div class="grid sm:grid-cols-3 gap-6">
                                        <div class="space-y-2">
                                            <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Código Postal</label>
                                            <div class="relative">
                                                <input v-model="profileForm.codigo_postal" @blur="buscarCP" type="text" maxlength="5" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                        ...
                                        <div class="col-span-2 space-y-2">
                                            <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Calle</label>
                                            <input v-model="profileForm.calle" type="text" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                        </div>
                                        <div class="space-y-2">
                                            <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">No. Exterior</label>
                                            <input v-model="profileForm.numero_exterior" type="text" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                        </div>
                                        <div class="space-y-2">
                                            <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">No. Interior</label>
                                            <input v-model="profileForm.numero_interior" type="text" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                        </div>
                                        <div class="space-y-2">
                                            <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Colonia</label>
                                            <template v-if="coloniasEncontradas.length > 0">
                                                <select v-model="profileForm.colonia" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner">
                                                    <option v-for="col in coloniasEncontradas" :key="col" :value="col">{{ col }}</option>
                                                </select>
                                            </template>
                                            <template v-else>
                                                <input v-model="profileForm.colonia" type="text" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                            </template>
                                        </div>
                                        <div class="space-y-2">
                                            <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Municipio</label>
                                            <input v-model="profileForm.municipio" type="text" readonly class="w-full bg-gray-100 dark:bg-gray-800 border-none rounded-2xl p-4 font-bold text-gray-500 dark:text-gray-400 cursor-not-allowed transition-colors shadow-inner" />
                                        </div>
                                        <div class="space-y-2">
                                            <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Estado</label>
                                            <select v-model="profileForm.estado" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-[3rem] p-10 shadow-xl border border-gray-100 dark:border-gray-700/50 transition-colors">
                                ...
                                <div class="grid sm:grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">RFC</label>
                                        <input 
                                            v-model="profileForm.rfc" 
                                            @blur="validateRfc"
                                            type="text" 
                                            maxlength="13"
                                            class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all uppercase shadow-inner"
                                    ...
                                    <div class="space-y-2">
                                        <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Domicilio Fiscal (C.P.)</label>
                                        <input v-model="profileForm.domicilio_fiscal_cp" type="text" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all shadow-inner" />
                                    </div>
                                    <div class="space-y-2 sm:col-span-2">
                                        <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Régimen Fiscal</label>
                                        <select v-model="profileForm.regimen_fiscal" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all text-xs shadow-inner">
                                    ...
                                    <div class="space-y-2 sm:col-span-2">
                                        <label class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest transition-colors">Uso de CFDI Sugerido</label>
                                        <select v-model="profileForm.uso_cfdi" class="w-full bg-gray-50 dark:bg-gray-900/50 border-none rounded-2xl p-4 font-bold text-gray-900 dark:text-white focus:ring-2 focus:ring-[var(--color-primary)] transition-all text-xs shadow-inner">
