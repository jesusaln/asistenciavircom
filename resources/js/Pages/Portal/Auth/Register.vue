                ...
                <div class="bg-white dark:bg-slate-900 dark:bg-gray-900 rounded-[3rem] shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 p-10 md:p-12 relative overflow-hidden group transition-colors duration-300">
                    ...
                    <div class="relative z-10">
                        <div class="text-center mb-10">
                            ...
                            <h2 class="text-3xl font-black text-gray-900 dark:text-white dark:text-white tracking-tight transition-colors">Registro Rápido</h2>
                            <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400 font-medium mt-2 transition-colors">Crea tu cuenta para comprar al instante.</p>
                        </div>

                        <form @submit.prevent="submit" class="space-y-5">
                            <div class="space-y-1">
                                <label class="text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 dark:text-gray-400 ml-1 transition-colors">Nombre Completo</label>
                                <input 
                                    v-model="form.nombre" 
                                    type="text" 
                            ...
                            <div class="space-y-1">
                                ...
                                <input 
                                    ...
                                    required
                                    class="w-full px-6 py-4 bg-white dark:bg-slate-900 border-gray-100 rounded-2xl focus:ring-4 focus:ring-[var(--color-primary-soft)] focus:border-[var(--color-primary)] transition-all font-medium"
                                >
                            ...
                            <div v-if="form.password" class="p-4 bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 space-y-3 transition-colors">
