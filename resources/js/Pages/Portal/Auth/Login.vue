                ...
                <div class="bg-white rounded-[3rem] shadow-2xl shadow-gray-200/50 border border-gray-100 p-10 md:p-12 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        <div class="text-center mb-10">
                            ...
                            <h2 class="text-3xl font-black text-gray-900 tracking-tight">Acceso Clientes</h2>
                            <p class="text-gray-500 font-medium mt-2">Ingrese sus credenciales para gestionar su soporte.</p>
                        </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <label class="flex items-center gap-3 cursor-pointer group/check">
                                <div class="relative flex items-center">
                                    ...
                                    <div class="w-5 h-5 border-2 border-gray-200 rounded-lg peer-checked:bg-[var(--color-primary)] peer-checked:border-[var(--color-primary)] transition-all"></div>
                                ...
                                <span class="text-[10px] font-black uppercase tracking-widest text-gray-400 group-hover/check:text-gray-600 transition-colors">Recordarme</span>
                            </label>
                            ...
                            <div class="text-center pt-4 border-t border-gray-100 mt-4">
                                <p class="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-4">¿No tienes cuenta de cliente?</p>
                                <Link 
