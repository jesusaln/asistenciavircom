            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    <div class="aspect-square rounded-2xl overflow-hidden bg-gray-50 relative group">
                        ...
                        <div class="absolute top-4 left-4 flex flex-col gap-2 z-20">
                            <span v-if="producto.categoria" 
                                  class="px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-xs font-medium text-gray-700 border border-gray-100">
                        ...
                        <div class="absolute top-4 right-4 z-20 flex flex-col gap-2 items-end">
                            ...
                            <!-- Bajo pedido -->
                            <span v-else class="px-3 py-1 rounded-full text-xs font-medium bg-amber-100 text-amber-700">
                                Bajo pedido
                            </span>
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-400 mb-4">
                        <Link :href="route('catalogo.index')" class="hover:text-gray-600 transition-colors">Tienda</Link>
                        <span>/</span>
                    ...
                    <!-- Brand -->
                    <p v-if="producto.marca" class="text-sm text-gray-500 mb-6">
                        Marca: <span class="font-bold text-gray-700">{{ producto.marca.nombre }}</span>
                    </p>
                    ...
                    <div class="mb-8 p-6 bg-gray-50 rounded-2xl border border-gray-100 inline-block align-self-start">
                        ...
                        <p class="text-sm text-gray-500 font-medium mt-1">IVA incluido</p>
                        <div v-if="producto.origen === 'CVA'" class="mt-3 flex items-center gap-2 text-blue-600 bg-blue-50 px-3 py-2 rounded-xl border border-blue-100">
                    ...
                    <!-- Description -->
                    <div class="mb-8">
                        <h3 class="text-xs font-black text-gray-400 uppercase tracking-[0.2em] mb-3">Descripción</h3>
                    ...
                    <div v-if="producto.ficha_comercial && !isSimilarToDescription(producto.ficha_comercial)" class="mb-8 p-6 bg-blue-50/50 rounded-2xl border border-blue-100">
                        <h3 class="text-xs font-black text-blue-400 uppercase tracking-[0.2em] mb-3">Información Comercial</h3>
                    ...
                    <div v-if="Object.keys(parsedSpecs).length > 0" class="mb-8">
                        <h3 class="text-xs font-black text-gray-400 uppercase tracking-[0.2em] mb-3">Especificaciones Técnicas</h3>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                            <span class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Código de producto</span>
                            <p class="text-sm font-bold text-gray-900 mt-1">{{ producto.codigo || 'N/A' }}</p>
                        </div>
                        <div v-if="producto.garantia" class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                            <span class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Garantía</span>
                            <p class="text-sm font-bold text-gray-900 mt-1">{{ producto.garantia }}</p>
                        </div>
                        <div v-else class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                            <span class="text-[10px] text-gray-400 uppercase font-bold tracking-wider">Presentación</span>
                            <p class="text-sm font-bold text-gray-900 mt-1">{{ producto.unidad_medida || 'PZA' }}</p>
                        </div>
                    </div>
                    ...
                    <div v-if="producto.stock_desglose && Object.keys(producto.stock_desglose).length > 0" class="mb-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <div v-for="(qty, branch) in producto.stock_desglose" :key="branch" 
                                ...
                                <span class="text-xs text-gray-600 font-medium">{{ branch }}:</span>
                    ...
                    <div v-if="producto.stock > 0 || producto.en_transito > 0" class="mb-6">
                        <div class="flex items-center gap-6 mb-4">
                            ...
                            <div class="flex items-center bg-gray-100 rounded-xl p-1">
                                ...
                                <span class="w-12 text-center font-black text-gray-900">{{ cantidad }}</span>
                                <button 
                                    @click="incrementar"
                                    class="w-10 h-10 flex items-center justify-center text-gray-500 hover:bg-white rounded-lg transition-all shadow-sm disabled:opacity-30"
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex gap-4">
                            <button v-if="producto.stock > 0 || producto.origen === 'CVA' || producto.en_transito > 0" 
                                    ...
                                    :class="agregado ? 'bg-green-500 shadow-green-200' : 'shadow-[var(--color-primary-soft)]'"
                            ...
                            <button v-if="producto.stock > 0 && empresaData?.whatsapp" 
                                    @click="openWhatsApp"
                                    class="p-4 rounded-2xl border-2 border-green-500 text-green-600 transition-all hover:bg-green-50">
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-bold text-amber-800">Tiempo de entrega estimado:</p>
                                    <p class="text-amber-700 text-lg font-semibold">3 a 5 días hábiles</p>
                                </div>
                            </div>
                        </div>
