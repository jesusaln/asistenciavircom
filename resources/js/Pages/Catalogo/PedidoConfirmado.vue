    ...
    <div class="min-h-screen bg-white dark:bg-slate-900 dark:bg-gray-900 flex flex-col font-sans" :style="cssVars">
        ...
        <main class="flex-grow w-full px-4 sm:px-6 lg:px-8 py-12 w-full">
            ...
            <div class="text-center mb-12">
                ...
                <h1 class="text-4xl font-black text-gray-900 dark:text-white dark:text-white mb-2 uppercase tracking-tight">¡Pedido Recibido!</h1>
                <p class="text-xl text-gray-500 dark:text-gray-400 dark:text-gray-400 font-medium">Gracias por tu compra, <span class="text-gray-900 dark:text-white dark:text-white font-bold">{{ pedido.nombre }}</span></p>
                <div class="mt-4 inline-block bg-white dark:bg-slate-900 dark:bg-gray-800 px-6 py-2 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm font-black text-[var(--color-primary)] text-lg">
            ...
            <div class="grid md:grid-cols-2 gap-8 items-start">
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-[2rem] p-8 shadow-sm border border-gray-100 dark:border-gray-700 relative overflow-hidden">
                        ...
                        <h2 class="text-xl font-black text-gray-900 dark:text-white dark:text-white mb-8 uppercase">Pasos a seguir</h2>
                        ...
                        <div class="space-y-8 relative">
                            ...
                            <div v-for="(step, index) in steps" :key="index" class="flex gap-6 relative">
                                <div class="w-12 h-12 rounded-2xl bg-white dark:bg-slate-900 dark:bg-gray-700 border-2 border-gray-100 dark:border-gray-600 flex items-center justify-center flex-shrink-0 z-10 group-hover:border-[var(--color-primary)] transition-colors shadow-sm">
                                    <span class="text-sm font-black text-[var(--color-primary)]">{{ index + 1 }}</span>
                                </div>
                                <div class="pt-1">
                                    <h3 class="font-black text-gray-900 dark:text-white dark:text-white text-sm uppercase mb-1">{{ step.title }}</h3>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 font-medium leading-relaxed">{{ step.desc }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-[2rem] p-8 shadow-sm border border-gray-100 dark:border-gray-700">
                        <h2 class="text-xl font-black text-gray-900 dark:text-white dark:text-white mb-6 uppercase">Detalles del Pedido</h2>
                        
                        <div class="space-y-4">
                            <div class="flex justify-between items-center py-2 border-b border-gray-50 dark:border-gray-700">
                                <span class="text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase">Método de Pago</span>
                                <span class="text-xs font-black text-gray-900 dark:text-white dark:text-white uppercase bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full">{{ metodoPagoLabel }}</span>
                            </div>
                            <div class="flex justify-between items-center py-2 border-b border-gray-50 dark:border-gray-700">
                                <span class="text-xs font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase">Costo Envío</span>
                                <span class="text-xs font-black text-gray-900 dark:text-white dark:text-white">{{ formatCurrency(pedido.costo_envio) }}</span>
                            </div>
                            <div class="flex justify-between items-center py-4">
                                <span class="text-sm font-black text-gray-900 dark:text-white dark:text-white uppercase">Total Final</span>
                        ...
                        <div v-if="pedido.metodo_pago === 'transferencia'" class="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700">
                            <h3 class="text-sm font-black text-gray-900 dark:text-white dark:text-white uppercase mb-4 flex items-center gap-2">
                            ...
                            <div class="bg-white dark:bg-slate-900 dark:bg-gray-700 rounded-2xl p-6 space-y-4">
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="space-y-1">
                                        <p class="text-[9px] font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase">Banco</p>
                                        <p class="text-xs font-black text-gray-900 dark:text-white dark:text-gray-100">{{ empresaData.banco }}</p>
                                    </div>
                                    <div class="space-y-1">
                                        <p class="text-[9px] font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase">Sucursal</p>
                                        <p class="text-xs font-black text-gray-900 dark:text-white dark:text-gray-100">{{ empresaData.sucursal }}</p>
                                    </div>
                                    <div class="space-y-1 col-span-2">
                                        <p class="text-[9px] font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase">Titular</p>
                                        <p class="text-xs font-black text-gray-900 dark:text-white dark:text-gray-100">{{ empresaData.titular || empresaData.razon_social }}</p>
                                    </div>
                                    <div class="space-y-1 col-span-2">
                                        <p class="text-[9px] font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase">CLABE Interbancaria</p>
                                        <p class="text-sm font-black text-[var(--color-primary)] tracking-wider">{{ empresaData.clabe }}</p>
                                    </div>
                                    <div class="space-y-1">
                                        <p class="text-[9px] font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase">Cuenta</p>
                                        <p class="text-xs font-black text-gray-800 dark:text-gray-100 dark:text-gray-200">{{ empresaData.cuenta }}</p>
                                    </div>
                                    <div class="space-y-1">
                                        <p class="text-[9px] font-bold text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase">Referencia</p>
                         ...
                         <div v-if="pedido.metodo_pago === 'efectivo' && pedido.direccion_envio?.tipo === 'recoger_en_tienda'" class="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <div class="bg-white dark:bg-slate-900 dark:bg-gray-700 rounded-2xl p-6">
                                <p class="text-xs font-bold text-gray-600 dark:text-gray-300 dark:text-gray-300 leading-relaxed mb-4">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <p class="text-[10px] font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wide">Abierto Lunes a Viernes de 9am a 7pm</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-8 bg-white dark:bg-slate-900 dark:bg-gray-800 rounded-[2rem] p-8 shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div class="flex items-start gap-4">
                        <div class="p-3 bg-white dark:bg-slate-900 dark:bg-gray-700 rounded-xl">
                            <svg class="w-6 h-6 text-gray-400 dark:text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                        </div>
                        <div>
                            <h4 class="text-xs font-black text-gray-900 dark:text-white dark:text-white uppercase">Información de Envío</h4>
                            <p v-if="pedido.direccion_envio.tipo === 'recoger_en_tienda'" class="text-xs font-bold text-gray-500 dark:text-gray-400 dark:text-gray-400 italic">Pasa a recoger en nuestra sucursal física.</p>
                            <p v-else class="text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 max-w-sm mt-1">
                    ...
                    <div class="flex -space-x-2">
                        <div v-for="(item, idx) in pedido.items.slice(0, 5)" :key="idx" class="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-700 border-2 border-white dark:border-gray-800 flex items-center justify-center text-[10px] font-black text-gray-400 dark:text-gray-500 dark:text-gray-400">
                            {{ item.nombre.charAt(0) }}
                        </div>
                        <div v-if="pedido.items.length > 5" class="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-600 border-2 border-white dark:border-gray-800 flex items-center justify-center text-[10px] font-black text-gray-600 dark:text-gray-300 dark:text-gray-300">
