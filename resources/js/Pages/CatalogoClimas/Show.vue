            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div class="relative">
                    <div class="aspect-square rounded-2xl overflow-hidden bg-white dark:bg-gray-800 relative group">
                        ...
                        <img v-if="getImageUrl(mainImage || producto)" 
                             ...
                             :alt="producto.nombre"
                             class="w-full h-full object-contain relative z-0 group-hover:scale-110 transition-transform duration-500 p-2" />
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <div class="mb-8 p-6 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 inline-block align-self-start">
                        ...
                        <p class="text-xs text-emerald-600 dark:text-emerald-400 font-black uppercase tracking-widest mt-2 flex items-center gap-2">
