            ...
            <div class="grid md:grid-cols-2 gap-8 items-start">
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-gray-800 rounded-[2rem] p-8 shadow-sm border border-gray-100 dark:border-gray-700">
                        ...
                        <div v-if="pedido.estado === 'pendiente' && (pedido.metodo_pago === 'mercadopago' || pedido.metodo_pago === 'paypal')" class="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700 space-y-4">
                            <div class="p-4 bg-amber-50 dark:bg-gray-700/50 rounded-2xl border border-amber-200/50 dark:border-gray-700 flex items-start gap-3">
                                <span class="text-amber-500 mt-0.5">⚠️</span>
                                <div class="text-xs">
                                    <p class="font-black text-amber-800 dark:text-amber-200 uppercase">Pago Pendiente</p>
                                    <p class="text-gray-500 dark:text-gray-400 font-medium">Por favor, completa tu pago para poder procesar y enviar tu pedido.</p>
                                </div>
                            </div>
