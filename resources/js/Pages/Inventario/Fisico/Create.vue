<template>
  <AppLayout title="Nueva Auditoría">
    <template #header>
      <div class="mb-8">
        <h2 class="text-2xl font-black text-[var(--ui-text)] uppercase tracking-tight">Nueva Sesión de Inventario</h2>
        <p class="text-sm font-bold text-[var(--ui-text-soft)] uppercase tracking-widest mt-1">Configura el punto de inicio para el conteo físico</p>
      </div>
    </template>
    ...
    <div class="px-6 pb-12">
      <div class="max-w-3xl mx-auto">
          ...
          <div class="grid grid-cols-1 gap-10 relative z-10">
            ...
            <div class="space-y-4">
              ...
              <div class="relative group/field">
                ...
                <input 
                  ...
                  class="w-full pl-14 pr-8 py-5 bg-[var(--ui-surface-soft)] border-2 border-[var(--ui-border)] rounded-2xl text-sm font-bold text-[var(--ui-text)] uppercase tracking-wider focus:border-[var(--ui-accent)] focus:ring-4 focus:ring-[var(--ui-accent)]/10 transition-all outline-none"
                  required
                >
              </div>
              <p v-if="form.errors.nombre" class="text-[10px] font-black text-rose-500 uppercase tracking-widest ml-2">{{ form.errors.nombre }}</p>
            </div>
            ...
            <div class="space-y-4">
              ...
              <div class="relative group/field">
                ...
                <select 
                  ...
                  class="w-full pl-14 pr-8 py-5 bg-[var(--ui-surface-soft)] border-2 border-[var(--ui-border)] rounded-2xl text-sm font-bold text-[var(--ui-text)] uppercase tracking-wider focus:border-[var(--ui-accent)] focus:ring-4 focus:ring-[var(--ui-accent)]/10 transition-all outline-none appearance-none"
                  required
                >
              ...
              <p v-if="form.errors.almacen_id" class="text-[10px] font-black text-rose-500 uppercase tracking-widest ml-2">{{ form.errors.almacen_id }}</p>
            </div>
            ...
            <div class="space-y-4">
              ...
              <textarea 
                ...
                class="w-full p-8 bg-[var(--ui-surface-soft)] border-2 border-[var(--ui-border)] rounded-3xl text-sm font-bold text-[var(--ui-text)] uppercase tracking-wider focus:border-[var(--ui-accent)] focus:ring-4 focus:ring-[var(--ui-accent)]/10 transition-all outline-none"
              ></textarea>
            </div>
            ...
            <div class="flex items-center justify-end gap-6 pt-6">
              ...
              <button 
                ...
                class="premium-button flex items-center gap-3 px-10 py-5 rounded-2xl bg-gradient-to-br from-[var(--ui-accent)] to-amber-600 text-white font-black uppercase tracking-[0.2em] text-xs shadow-xl shadow-amber-500/20 hover:scale-105 active:scale-95 disabled:opacity-50 transition-all duration-300"
              >
        ...
        <!-- Información Útil -->
        <div class="mt-12 flex items-start gap-6 px-12 py-8 rounded-[2rem] bg-blue-500/5 border border-blue-500/20">
          <div class="w-10 h-10 rounded-xl bg-blue-500 flex items-center justify-center text-white shrink-0">
            <font-awesome-icon icon="circle-info" />
          </div>
          <div>
            <h4 class="text-[10px] font-black text-blue-500 uppercase tracking-widest mb-1">Nota sobre el proceso</h4>
