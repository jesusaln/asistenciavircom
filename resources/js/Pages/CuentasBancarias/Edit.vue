        ...
        <div class="relative group">
          ...
          <div class="relative bg-slate-900/80 backdrop-blur-xl border border-slate-800 rounded-[2.5rem] shadow-2xl overflow-hidden p-8 md:p-12">
            <form @submit.prevent="submit" class="space-y-8">
              ...
              <!-- Activa -->
              <div class="flex items-center gap-3 p-4 bg-slate-950/30 border border-slate-800 rounded-2xl animate-pulse-slow">
                <div class="relative inline-flex items-center cursor-pointer">
                  ...
                  <span class="ml-3 text-sm font-semibold text-slate-200">Cuenta Activa</span>
                </div>
              </div>
