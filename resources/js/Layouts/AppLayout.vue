                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <button
                            ...
                            class="p-2 rounded-lg hover:bg-gray-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-amber-500"
                            :title="isDarkMode ? 'Cambiar a modo claro' : 'Cambiar a modo oscuro'"
                        >
                            <!-- Sol (modo oscuro activo) -->
                            <svg v-if="isDarkMode" class="w-5 h-5 text-amber-400" fill="currentColor" viewBox="0 0 20 20">
