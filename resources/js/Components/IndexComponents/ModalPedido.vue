          ...
          <div class="lg:col-span-2 space-y-6">
              ...
              <div class="px-6 py-4 border-b border-gray-200 dark:border-slate-800 bg-gray-50">
                <div class="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p class="text-base font-bold text-gray-900 dark:text-white">{{ selected?.cliente?.nombre_razon_social || 'Desconocido' }}</p>
                    ...
                    <div class="space-y-2 text-sm">
                      <div v-if="selected?.almacen" class="space-y-1">
                        <div class="flex items-center">
                          ...
                          <span class="ml-2 font-medium text-gray-900 dark:text-white">{{ selected.almacen?.nombre }}</span>
                        </div>
                        <div v-if="selected.almacen?.descripcion" class="ml-6 text-sm text-gray-500 dark:text-gray-400">{{ selected.almacen.descripcion }}</div>
                        <div v-if="selected.almacen?.ubicacion" class="ml-6 text-sm text-gray-500 dark:text-gray-400">Ubicación: {{ selected.almacen.ubicacion }}</div>
                      </div>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-gray-200 dark:border-slate-800">
              ...
              <div v-else class="px-6 py-12 text-center">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Este pedido no tiene productos o servicios registrados.</p>
              </div>
            </div>
          </div>
