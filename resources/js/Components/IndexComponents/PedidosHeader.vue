<template>
  <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden transition-colors index-header-root" :style="cssVars">
    <!-- Header con estadísticas -->
    <div class="px-6 py-6 border-b border-white/30 dark:border-slate-700 text-white bg-gradient-to-br from-blue-500 to-brand-600 dark:from-gray-800 dark:to-gray-900">
      <div class="flex items-center justify-between mb-6">
        ...
        <button
          @click="onCrearNueva"
          class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-xl text-white shadow-sm hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-white/60 focus:ring-offset-2 focus:ring-offset-transparent transition-all duration-200"
      ...
      <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
        <div class="bg-white/80 dark:bg-slate-800/50 rounded-xl p-4 border border-white/40 dark:border-white/20 backdrop-blur-sm">
    ...
    <!-- Filtros y búsqueda -->
    <div class="px-6 py-4 bg-transparent/60 dark:bg-slate-900/50 border-b border-slate-200/60 dark:border-slate-700">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
        ...
        <div class="flex-1 max-w-md">
          <div class="relative">
            ...
            <input
              ...
              class="block w-full pl-10 pr-3 py-2 border border-slate-300 dark:border-slate-600 rounded-xl leading-5 bg-white dark:bg-slate-800 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:placeholder-slate-400 focus:ring-1 focus:border-transparent text-sm transition-colors"
        ...
        <div class="flex items-center space-x-3">
          ...
          <select
            ...
            class="block w-48 pl-3 pr-10 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-xl focus:outline-none focus:ring-1 focus:border-transparent bg-white dark:bg-slate-800 dark:text-white transition-colors"
            :style="focusRingStyle"
          >
          ...
          <button
            ...
            class="inline-flex items-center px-3 py-2 border border-slate-300 dark:border-slate-600 text-sm leading-4 font-medium rounded-xl text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 hover:bg-slate-700 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200"
            :style="focusRingStyle"
          >
