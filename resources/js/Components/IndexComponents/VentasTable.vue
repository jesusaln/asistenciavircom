        ...
        <thead class="bg-gray-50/50 dark:bg-slate-950/50">
          <tr>
            ...
            <th class="px-6 py-5 text-left hidden lg:table-cell">
              <span class="text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-[0.2em]">Pago</span>
            </th>
        ...
        <tbody class="divide-y divide-gray-50 dark:divide-slate-800/50">
          <tr v-for="documento in items" :key="documento.id"
            ...
            <td class="px-6 py-5 text-left hidden lg:table-cell max-w-[140px]">
              <span class="text-[10px] font-black text-gray-800 dark:text-slate-200 uppercase leading-snug block truncate" :title="textoPago(documento)">
                {{ textoPago(documento) }}
              </span>
              <span v-if="documento.metodo_pago_sat || documento.forma_pago_sat" class="text-[8px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-tighter mt-0.5 block truncate">
            ...
            <td class="px-6 py-5 text-right">
              <div class="flex items-center justify-end gap-2 flex-nowrap">
                ...
                <button
                  ...
                  class="p-2 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/40 transition-all shadow-sm hover:shadow-md hover:scale-105 active:scale-95"
