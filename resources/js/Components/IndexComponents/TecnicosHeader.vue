  ...
  <div class="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden index-header-root">
    ...
    <div class="px-6 py-6 border-b border-slate-200/60">
      <div class="flex items-center justify-between mb-6">
        <div>
          <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Técnicos</h1>
          <p class="text-sm text-slate-600 mt-1">Gestiona todos tus técnicos en un solo lugar</p>
        </div>
        <button
          @click="onCrearNueva"
      ...
      <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <div class="bg-white/70 rounded-xl p-4 border border-slate-200/50">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-slate-600">Con Especialidad</p>
        ...
        <div class="bg-white/70 rounded-xl p-4 border border-slate-200/50">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-slate-600">Con Certificación</p>
