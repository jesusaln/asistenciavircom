    ...
    >
        <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4 bg-[var(--ui-surface)] text-[var(--ui-text)]">
            <div class="sm:flex sm:items-start">
                <div class="mx-auto shrink-0 flex items-center justify-center size-12 rounded-full bg-rose-100/90 dark:bg-rose-900/30 sm:mx-0 sm:size-10">
        ...
        <div class="flex flex-row justify-end px-6 py-4 text-end bg-[var(--ui-surface-alt)] border-t border-[var(--ui-border)]">
            <slot name="footer" />
        </div>
    </Modal>
</template>
