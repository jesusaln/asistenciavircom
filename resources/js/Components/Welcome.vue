...
<template>
    <div>
        <div class="p-6 lg:p-8 bg-white dark:bg-slate-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-slate-200 dark:border-slate-700">
