...
<template>
    <section id="agendar-cita" :style="cssVars">
                ...
                <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <div v-if="showSuccess" class="max-w-2xl mx-auto mb-10">
                            <div class="p-8 bg-green-500/10 border border-green-500/20 rounded-3xl backdrop-blur-sm text-center">
                                ...
                                <p class="text-green-300 text-base">Uno de nuestros asesores te contactará en las próximas horas para confirmar los detalles de tu visita.</p>
                            </div>
                        </div>
                    </Transition>
                    ...
                    <Transition enter-active-class="transition-all duration-500 ease-out" enter-from-class="opacity-0 -translate-y-4" enter-to-class="opacity-100 translate-y-0">
                        <div v-if="errorMessage" class="max-w-2xl mx-auto mb-10 p-6 bg-red-500/10 border border-red-500/20 rounded-2xl flex items-center gap-4">
                            <font-awesome-icon icon="triangle-exclamation" class="text-red-400 text-2xl" />
                            <p class="text-red-300 text-sm flex-1">{{ errorMessage }}</p>
                            <button @click="errorMessage = ''" class="text-red-400 hover:text-red-300"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg></button>
                        </div>
                    </Transition>
                    <Transition enter-active-class="transition-all duration-500 ease-out" enter-from-class="opacity-0 -translate-y-4" enter-to-class="opacity-100 translate-y-0">
                        <div v-if="showSessionExpired" class="max-w-2xl mx-auto mb-10 p-6 bg-amber-500/10 border border-amber-500/20 rounded-2xl">
                            <div class="flex items-start gap-4">
                                <font-awesome-icon icon="sync" class="text-amber-400 text-2xl" />
                                <div class="flex-1">
                                    <p class="text-amber-300 text-sm mb-3">Tu sesión ha expirado. Por favor, recarga la página e intenta nuevamente.</p>
                                    <button @click="reloadPage" class="px-4 py-2 bg-amber-500 text-white rounded-xl font-bold text-sm hover:bg-amber-600 transition-colors">Recargar Página</button>
                                </div>
                            </div>
                        </div>
                    </Transition>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
                        ...
                        <div>
                            <span class="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full mb-8">
                                ...
                                <span class="text-green-400 text-[10px] font-black uppercase tracking-[0.2em]">Respondemos en menos de 2 horas</span>
                            </span>
                            ...
                            <p class="text-lg md:text-xl text-gray-400 leading-relaxed mb-10 max-w-lg">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-xs">Personal capacitado y uniformado</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-xl">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-xs">En cada servicio que realizamos</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-xl">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-xs">Tu información está segura con nosotros</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            <!-- Glow behind card -->
                            <div class="absolute -inset-4 bg-gradient-to-br from-[var(--color-primary)]/20 to-amber-500/10 rounded-[3rem] blur-2xl opacity-40"></div>

                            <div class="relative bg-white dark:bg-gray-800 rounded-[2rem] p-8 md:p-10 shadow-2xl border border-gray-100 dark:border-gray-700">
                                <!-- Form Header -->
                                <div class="text-center mb-8">
                                    ...
                                    <h3 class="text-2xl font-black text-gray-900 dark:text-white">Solicita tu Visita</h3>
                                    <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Completa estos datos y te llamamos</p>
                                </div>

                                <form @submit.prevent="submitForm" class="space-y-5">
                                    <!-- Nombre -->
                                    <div>
                                        <label for="simplified-nombre" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                                        ...
                                        <input
                                            ...
                                            class="w-full px-5 py-4 rounded-xl bg-gray-50 dark:bg-gray-900 border-2 border-gray-100 dark:border-gray-700 text-gray-900 dark:text-white text-base outline-none transition-all focus:border-[var(--color-primary)] focus:bg-white dark:focus:bg-gray-800 focus:shadow-lg focus:shadow-[var(--color-primary)]/5 placeholder:text-gray-400"
                                        >
                                    </div>
                                    ...
                                    <div>
                                        <div class="flex items-end justify-between mb-2">
                                            <label for="simplified-telefono" class="block text-sm font-bold text-gray-700 dark:text-gray-300">
                                                <span class="inline-flex items-center gap-2">
                                            ...
                                            <Transition enter-active-class="transition-all duration-300" enter-from-class="opacity-0 translate-x-2" enter-to-class="opacity-100 translate-x-0">
                                                <span v-if="form.telefono && !isPhoneValid" class="text-[10px] text-red-500 font-extrabold animate-pulse">
                                                    {{ 10 - form.telefono.length }} dígitos restantes
                                                </span>
                                                <span v-else-if="isPhoneValid" class="text-[10px] text-green-500 font-extrabold flex items-center gap-1">
                                        ...
                                        <input
                                            ...
                                            class="w-full px-5 py-4 rounded-xl bg-gray-50 dark:bg-gray-900 border-2 border-gray-100 dark:border-gray-700 text-gray-900 dark:text-white text-base outline-none transition-all focus:border-[var(--color-primary)] focus:bg-white dark:focus:bg-gray-800 focus:shadow-lg focus:shadow-[var(--color-primary)]/5 placeholder:text-gray-400"
                                            :class="{
                                                'border-red-300 bg-red-50 dark:bg-red-900/10': form.telefono && !isPhoneValid,
                                                'border-green-400 bg-green-50/50 dark:bg-green-900/10': isPhoneValid
                                            }"
                                        >
                                    </div>
                                        ...
                                        <label class="flex items-start gap-3 cursor-pointer group select-none">
                                            <div class="relative flex-shrink-0 mt-0.5">
                                                <input
                                                    ...
                                                    class="sr-only peer"
                                                >
                                                <div class="w-5 h-5 rounded-md border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 transition-all peer-checked:bg-[var(--color-primary)] peer-checked:border-[var(--color-primary)] group-hover:border-[var(--color-primary)]/50 flex items-center justify-center">
        ...
        <!-- ============================================ -->
        <template v-else>
            <div class="py-20 md:py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 relative overflow-hidden transition-colors duration-300">
                ...
                <div class="max-w-6xl mx-auto px-4 relative z-10">
                    ...
                    <Transition enter-active-class="transition-all duration-500 ease-out" enter-from-class="opacity-0 -translate-y-4" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition-all duration-300 ease-in" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 -translate-y-4">
                        <div v-if="showSuccess" class="mb-8 p-6 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-2xl flex items-center gap-4">
                            <div class="w-12 h-12 bg-green-100 dark:bg-green-800 rounded-full flex items-center justify-center text-2xl"><font-awesome-icon icon="check-circle" /></div>
                            <div><h4 class="font-bold text-green-800 dark:text-green-300">¡Cita Registrada!</h4><p class="text-green-700 dark:text-green-400 text-sm">Te contactaremos pronto para confirmar los detalles.</p></div>
                        </div>
                    </Transition>
                    <Transition enter-active-class="transition-all duration-500 ease-out" enter-from-class="opacity-0 -translate-y-4" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition-all duration-300 ease-in" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 -translate-y-4">
                        <div v-if="errorMessage" class="mb-8 p-6 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-2xl flex items-center gap-4">
                            <div class="w-12 h-12 bg-red-100 dark:bg-red-800 rounded-full flex items-center justify-center text-2xl"><font-awesome-icon icon="triangle-exclamation" /></div>
                            <div class="flex-1"><h4 class="font-bold text-red-800 dark:text-red-300">Horario No Disponible</h4><p class="text-red-700 dark:text-red-400 text-sm">{{ errorMessage }}</p></div>
                            <button @click="errorMessage = ''" class="text-red-400 hover:text-red-600"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg></button>
                        </div>
                    </Transition>
                    <Transition enter-active-class="transition-all duration-500 ease-out" enter-from-class="opacity-0 -translate-y-4" enter-to-class="opacity-100 translate-y-0">
                        <div v-if="showSessionExpired" class="mb-8 p-6 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-2xl">
                            <div class="flex items-start gap-4">
                                <div class="w-12 h-12 bg-amber-100 dark:bg-amber-800 rounded-full flex items-center justify-center text-2xl flex-shrink-0"><font-awesome-icon icon="sync" /></div>
                                <div class="flex-1">
                                    <h4 class="font-bold text-amber-800 dark:text-amber-300 mb-1">Sesión Expirada</h4>
                                    <p class="text-amber-700 dark:text-amber-400 text-sm mb-4">Tu sesión ha expirado. Por favor, recarga la página.</p>
                                    <button @click="reloadPage" class="px-5 py-2.5 bg-amber-500 text-white rounded-xl font-bold text-sm hover:bg-amber-600 transition-colors">Recargar</button>
                                </div>
                            </div>
                        </div>
                    </Transition>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-start">
                            ...
                            <div class="mt-10 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700 transition-colors">
                                ...
                                <div class="space-y-3">
                                    <div v-for="t in ['Respuesta en menos de 2 horas', 'Técnicos certificados y uniformados', 'Garantía por escrito en todos los servicios']" :key="t" class="flex items-center gap-3">
                                        <span class="w-8 h-8 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center text-green-600 dark:text-green-400 text-sm"><font-awesome-icon icon="check" /></span>
                                        <span class="text-gray-700 dark:text-gray-300 text-sm font-medium transition-colors">{{ t }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 transition-colors">
                            ...
                            <form @submit.prevent="submitForm" class="space-y-5">
                                <div>
                                    <label for="full-nombre" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Nombre completo *</label>
                                    <input id="full-nombre" v-model="form.nombre" type="text" required placeholder="Ej: Juan Pérez" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all outline-none">
                                </div>
                                <div>
                                    <div class="flex justify-between items-end mb-2">
                                        <label for="full-telefono" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Teléfono *</label>
                                        <span v-if="form.telefono && !isPhoneValid" class="text-[10px] text-red-500 font-bold animate-pulse">10 dígitos requeridos</span>
                                    </div>
                                    <input id="full-telefono" :value="form.telefono" @input="handlePhoneInput" type="tel" required maxlength="10" placeholder="6621234567" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all outline-none" :class="{'border-red-300': form.telefono && !isPhoneValid}">
                                </div>
                                <div>
                                    <label for="full-email" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Email (opcional)</label>
                                    <input id="full-email" v-model="form.email" type="email" placeholder="tu@email.com" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all outline-none">
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label for="full-fecha" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Fecha preferida</label>
                                        <input id="full-fecha" v-model="form.fecha_preferida" type="date" :min="minDate" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white dark:[color-scheme:dark] focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all outline-none">
                                    </div>
                                    <div>
                                        <label for="full-hora" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Hora preferida</label>
                                        <select id="full-hora" v-model="form.hora_preferida" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all outline-none bg-white dark:bg-gray-900 dark:text-white">
                                ...
                                <div>
                                    <label for="full-descripcion" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Detalles adicionales</label>
                                    <textarea id="full-descripcion" v-model="form.descripcion" rows="3" placeholder="Describe brevemente tu necesidad..." class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/20 transition-all outline-none resize-none"></textarea>
                                </div>
