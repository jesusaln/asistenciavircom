<template>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div v-if="showHeader" class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div v-if="searchable" class="relative">
                        <input
                            ...
                            class="w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                            @input="handleSearch"
                        />
                        ...
                        <tr>
                            <td :colspan="columns.length" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p v-if="emptyDescription" class="text-sm text-gray-400 mt-1">{{ emptyDescription }}</p>
                    ...
                    <template v-else>
                        ...
                        <tr 
                            ...
                            :class="[
                                ...
                                hoverable ? 'hover:bg-amber-50/50 cursor-pointer' : '',
        ...
        <!-- Pagination -->
        <div v-if="showPagination && pagination" class="px-6 py-4 border-t border-gray-100 bg-gray-50/50">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <!-- Info -->
