...
// Subir backup a Google Drive y limpiar locales viejos (corre después del backup diario)
Schedule::command('backup:sync-cloud --clean-local')
    ->dailyAt('03:30')
    ->name('backup-sync-cloud')
    ->withoutOverlapping()
