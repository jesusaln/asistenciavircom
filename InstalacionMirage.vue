...
const costosAdicionales = [
    ...
    { item: 'Metro lineal de cable para tierra física - Ya instalado', precio: '$70', icono: 'plug' },
    ...
    { item: 'Retirar un equipo (Mano de obra)', precio: '$500', icono: 'trash-alt' },
...
const faqs = [
    { id: 1, pregunta: '¿Qué significa que sea "Sin Costo"?', respuesta: 'Significa que la mano de obra básica y el kit incluido en la caja son gratuitos. Mirage y LG cubren estos conceptos a través de sus centros de servicio autorizados como nosotros.' },
...
<template>
    <Head title="Instalación Mirage y LG Sin Costo - Términos y Condiciones">
        <meta name="description" content="Detalle de lo que incluye y no incluye la promoción de instalación sin costo de Mirage y LG con Climas del Desierto." />
    </Head>
            ...
            <section class="relative pt-40 pb-32 px-4 overflow-hidden min-h-[90vh] flex items-center justify-center text-center">
                ...
                <div class="max-w-7xl mx-auto relative z-10">
                    <div class="inline-flex items-center gap-2 px-4 py-2 bg-[var(--color-primary)] rounded-full border border-white/20 mb-8 animate-bounce-slow">
                        <span class="text-white text-xs font-bold uppercase tracking-wide">Centro de Servicio Autorizado Mirage y LG</span>
                    </div>
                    ...
                    <p class="max-w-2xl mx-auto text-xl md:text-2xl text-slate-200 mb-12 leading-relaxed font-medium">
                        ¿Compraste tu equipo Mirage o LG en una tienda departamental? <br>
                        Aquí te detallamos <strong class="text-white hover:underline decoration-[var(--color-primary)] underline-offset-8">exactamente</strong> qué incluye tu beneficio y qué servicios adicionales podrías necesitar.
                    </p>
                    ...
                    <div class="grid lg:grid-cols-2 gap-12">
                        ...
                        <div class="bg-emerald-50 dark:bg-emerald-900/20/50 dark:bg-slate-800/10 rounded-[3rem] p-8 md:p-12 border border-emerald-100 dark:border-emerald-900/30">
                            <div class="flex items-center gap-4 mb-10">
                                <div class="w-16 h-16 bg-brand-500 rounded-2xl flex items-center justify-center text-3xl shadow-xl shadow-emerald-500/20">
                                    ✅
                                </div>
                                <div>
                                    <h2 class="text-2xl font-black text-slate-100 text-slate-100 tracking-tight">Sí Incluye</h2>
                                    <p class="text-emerald-600 dark:text-slate-400 font-bold uppercase tracking-wide text-xs">Conceptos Sin Costo</p>
                                </div>
                            </div>
                        ...
                        <div class="bg-rose-50 dark:bg-rose-900/20/50 dark:bg-rose-900/10 rounded-[3rem] p-8 md:p-12 border border-rose-100 dark:border-rose-900/30">
                            <div class="flex items-center gap-4 mb-10">
                                <div class="w-16 h-16 bg-brand-500 rounded-2xl flex items-center justify-center text-3xl shadow-xl shadow-rose-500/20">
                                    ❌
                                </div>
                                <div>
